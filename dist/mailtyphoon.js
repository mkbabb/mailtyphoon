...
import nf from "crypto";
import Su from "fs";
import { LRUCache as cf } from "lru-cache";
import Kt from "path";
import { hideBin as sf } from "yargs/helpers";
import of from "yargs/yargs";
import en from "os";
import * as df from "sass";
import { spawn as lf } from "child_process";
...
ia.toByteArray = mf;
ia.fromByteArray = Tf;
var Uu = [], Cu = [], ff = typeof Uint8Array < "u" ? Uint8Array : Array, un = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var qt = 0, bf = un.length; qt < bf; ++qt)
  Uu[qt] = un[qt], Cu[un.charCodeAt(qt)] = qt;
Cu["-".charCodeAt(0)] = 62;
...
function mf(e) {
  var u, t = js(e), r = t[0], a = t[1], n = new ff(pf(e, r, a)), i = 0, c = a > 0 ? r - 4 : r, o;
  for (o = 0; o < c; o += 4)
...
function gf(e) {
  return Uu[e >> 18 & 63] + Uu[e >> 12 & 63] + Uu[e >> 6 & 63] + Uu[e & 63];
}
function Ef(e, u, t) {
  for (var r, a = [], n = u; n < t; n += 3)
    r = (e[n] << 16 & 16711680) + (e[n + 1] << 8 & 65280) + (e[n + 2] & 255), a.push(gf(r));
  return a.join("");
}
function Tf(e) {
  for (var u, t = e.length, r = t % 3, a = [], n = 16383, i = 0, c = t - r; i < c; i += n)
    a.push(Ef(e, i, i + n > c ? c : i + n));
  return r === 1 ? (u = e[t - 1], a.push(
    Uu[u >> 2] + Uu[u << 4 & 63] + "=="
  )) : r === 2 && (u = (e[t - 2] << 8) + e[t - 1], a.push(
    Uu[u >> 10] + Uu[u >> 4 & 63] + Uu[u << 2 & 63] + "="
  )), a.join("");
}
var _i = {};
...
_i.write = function(e, u, t, r, a, n) {
  var i, c, o, d = n * 8 - a - 1, s = (1 << d) - 1, E = s >> 1, b = a === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, m = r ? 0 : n - 1, A = r ? 1 : -1, L = u < 0 || u === 0 && 1 / u < 0 ? 1 : 0;
  for (u = Math.abs(u), isNaN(u) || u === 1 / 0 ? (c = isNaN(u) ? 1 : 0, i = s) : (i = Math.floor(Math.log(u) / Math.LN2), u * (o = Math.pow(2, -i)) < 1 && (i--, o *= 2), i + E >= 1 ? u += b / o : u += b * Math.pow(2, 1 - E), u * o >= 2 && (i++, o /= 2), i + E >= s ? (c = 0, i = s) : i + E >= 1 ? (c = (u * o - 1) * Math.pow(2, a), i = i + E) : (c = u * Math.pow(2, E - 1) * Math.pow(2, a), i = 0)); a >= 8; e[t + m] = c & 255, m += A, c /= 256, a -= 8)
    ;
  for (i = i << a | c, d += a; d > 0; e[t + m] = i & 255, m += A, i /= 256, d -= 8)
    ;
  e[t + m - A] |= L * 128;
};
/*!
...
(function(e) {
  ...
  function A(y) {
    if (ee(y, Uint8Array)) {
      const h = new Uint8Array(y);
      return L(h.buffer, h.byteOffset, h.byteLength);
    }
    return m(y);
  }
  function L(y, h, p) {
  ...
  c.isBuffer = function(h) {
    ...
    if (h === p)
      return 0;
    let N = h.length, P = p.length;
    for (let H = 0, q = Math.min(N, P); H < q; ++H)
      if (h[H] !== p[H]) {
        N = h[H], P = p[H];
        break;
      }
    ...
    for (N = 0; N < h.length; ++N) {
      let q = h[N];
      if (ee(q, Uint8Array))
        H + q.length > P.length ? (c.isBuffer(q) || (q = c.from(q)), q.copy(P, H)) : Uint8Array.prototype.set.call(
          P,
          q,
          H
        );
  ...
  c.prototype.swap16 = function() {
    ...
    const h = this.length;
    return h === 0 ? "" : arguments.length === 0 ? v(this, 0, h) : B.apply(this, arguments);
  ...
  }, r && (c.prototype[r] = c.prototype.inspect), c.prototype.compare = function(h, p, N, P, H) {
    ...
    if (p === void 0 && (p = 0), N === void 0 && (N = h ? h.length : 0), P === void 0 && (P = 0), H === void 0 && (H = this.length), p < 0 || N > h.length || P < 0 || H > this.length)
    ...
    if (p >= N)
      return 1;
    if (p >>>= 0, N >>>= 0, P >>>= 0, H >>>= 0, this === h)
      return 0;
    let q = H - P, ie = N - p;
    const Ie = Math.min(q, ie), Ae = this.slice(P, H), De = h.slice(p, N);
  ...
  function F(y, h, p, N, P) {
    if (y.length === 0)
      return -1;
    if (typeof p == "string" ? (N = p, p = 0) : p > 2147483647 ? p = 2147483647 : p < -2147483648 && (p = -2147483648), p = +p, ce(p) && (p = P ? 0 : y.length - 1), p < 0 && (p = y.length + p), p >= y.length) {
      if (P)
        return -1;
      p = y.length - 1;
    } else if (p < 0)
    ...
    if (typeof h == "string" && (h = c.from(h, N)), c.isBuffer(h))
      return h.length === 0 ? -1 : z(y, h, p, N, P);
    if (typeof h == "number")
      return h = h & 255, typeof Uint8Array.prototype.indexOf == "function" ? P ? Uint8Array.prototype.indexOf.call(y, h, p) : Uint8Array.prototype.lastIndexOf.call(y, h, p) : z(y, [h], p, N, P);
    throw new TypeError("val must be string, number or Buffer");
  }
  function z(y, h, p, N, P) {
  ...
  function g(y, h, p, N) {
    return Q(ut(h, y.length - p), y, p, N);
  }
  c.prototype.write = function(h, p, N, P) {
    if (p === void 0)
      P = "utf8", N = this.length, p = 0;
    else if (N === void 0 && typeof p == "string")
      P = p, N = this.length, p = 0;
    else if (isFinite(p))
      p = p >>> 0, isFinite(N) ? (N = N >>> 0, P === void 0 && (P = "utf8")) : (P = N, N = void 0);
    else
      throw new Error(
      ...
      if (P + ie <= p) {
        ...
        switch (ie) {
          case 1:
            ...
            break;
          case 2:
            Ie = y[P + 1], (Ie & 192) === 128 && (ge = (H & 31) << 6 | Ie & 63, ge > 127 && (q = ge));
            break;
          case 3:
            Ie = y[P + 1], Ae = y[P + 2], (Ie & 192) === 128 && (Ae & 192) === 128 && (ge = (H & 15) << 12 | (Ie & 63) << 6 | Ae & 63, ge > 2047 && (ge < 55296 || ge > 57343) && (q = ge));
            break;
          case 4:
            Ie = y[P + 1], Ae = y[P + 2], De = y[P + 3], (Ie & 192) === 128 && (Ae & 192) === 128 && (De & 192) === 128 && (ge = (H & 15) << 18 | (Ie & 63) << 12 | (Ae & 63) << 6 | De & 63, ge > 65535 && ge < 1114112 && (q = ge));
        }
      }
      q === null ? (q = 65533, ie = 1) : q > 65535 && (q -= 65536, N.push(q >>> 10 & 1023 | 55296), q = 56320 | q & 1023), N.push(q), P += ie;
    }
    return k(N);
  }
  const D = 4096;
  ...
  function W(y, h, p) {
    ...
    for (let H = 0; H < N.length - 1; H += 2)
      P += String.fromCharCode(N[H] + N[H + 1] * 256);
    return P;
  }
  ...
  c.prototype.readUintLE = c.prototype.readUIntLE = function(h, p, N) {
    ...
    const P = p + this[++h] * 2 ** 8 + this[++h] * 2 ** 16 + this[++h] * 2 ** 24, H = this[++h] + this[++h] * 2 ** 8 + this[++h] * 2 ** 16 + N * 2 ** 24;
    return BigInt(P) + (BigInt(H) << BigInt(32));
  }), c.prototype.readBigUInt64BE = Ue(function(h) {
    h = h >>> 0, Ve(h, "offset");
    const p = this[h], N = this[h + 7];
    (p === void 0 || N === void 0) && _e(h, this.length - 8);
    const P = p * 2 ** 24 + this[++h] * 2 ** 16 + this[++h] * 2 ** 8 + this[++h], H = this[++h] * 2 ** 24 + this[++h] * 2 ** 16 + this[++h] * 2 ** 8 + N;
    ...
    for (; ++q < p && (H *= 256); )
      P += this[h + q] * H;
    return H *= 128, P >= H && (P -= Math.pow(2, 8 * p)), P;
  }, c.prototype.readIntBE = function(h, p, N) {
    h = h >>> 0, p = p >>> 0, N || te(h, p, this.length);
    let P = p, H = 1, q = this[h + --P];
    for (; P > 0 && (H *= 256); )
      q += this[h + --P] * H;
    ...
    const p = this[h], N = this[h + 7];
    (p === void 0 || N === void 0) && _e(h, this.length - 8);
    const P = this[h + 4] + this[h + 5] * 2 ** 8 + this[h + 6] * 2 ** 16 + (N << 24);
    ...
    return (BigInt(P) << BigInt(32)) + BigInt(this[++h] * 2 ** 24 + this[++h] * 2 ** 16 + this[++h] * 2 ** 8 + N);
  ...
  c.prototype.writeUintLE = c.prototype.writeUIntLE = function(h, p, N, P) {
    if (h = +h, p = p >>> 0, N = N >>> 0, !P) {
    ...
    for (this[p] = h & 255; ++q < N && (H *= 256); )
      this[p + q] = h / H & 255;
    return p + N;
  }, c.prototype.writeUintBE = c.prototype.writeUIntBE = function(h, p, N, P) {
    if (h = +h, p = p >>> 0, N = N >>> 0, !P) {
      const ie = Math.pow(2, 8 * N) - 1;
      re(this, h, p, N, ie, 0);
    }
  ...
  c.prototype.writeBigUInt64LE = Ue(function(h, p = 0) {
  ...
  }), c.prototype.writeIntLE = function(h, p, N, P) {
    if (h = +h, p = p >>> 0, !P) {
      const Ie = Math.pow(2, 8 * N - 1);
    ...
    return p + N;
  }, c.prototype.writeIntBE = function(h, p, N, P) {
    if (h = +h, p = p >>> 0, !P) {
      const Ie = Math.pow(2, 8 * N - 1);
      re(this, h, p, N, Ie - 1, -Ie);
    }
  ...
  function he(y, h, p, N, P, H) {
    if (p + N > y.length)
      throw new RangeError("Index out of range");
    if (p < 0)
      throw new RangeError("Index out of range");
  }
  function hu(y, h, p, N, P) {
    return h = +h, p = p >>> 0, P || he(y, h, p, 4), t.write(y, h, p, N, 23, 4), p + 4;
  }
  ...
  function Du(y, h, p, N, P) {
    return h = +h, p = p >>> 0, P || he(y, h, p, 8), t.write(y, h, p, N, 52, 8), p + 8;
  }
  c.prototype.writeDoubleLE = function(h, p, N) {
  ...
  }, c.prototype.copy = function(h, p, N, P) {
    if (!c.isBuffer(h))
      throw new TypeError("argument should be a Buffer");
    if (N || (N = 0), !P && P !== 0 && (P = this.length), p >= h.length && (p = h.length), p || (p = 0), P > 0 && P < N && (P = N), P === N || h.length === 0 || this.length === 0)
      return 0;
    if (p < 0)
    ...
    P > this.length && (P = this.length), h.length - p < P - N && (P = h.length - p + N);
    const H = P - N;
    return this === h && typeof Uint8Array.prototype.copyWithin == "function" ? this.copyWithin(p, N, P) : Uint8Array.prototype.set.call(
      h,
      this.subarray(N, P),
      p
    ), H;
  }, c.prototype.fill = function(h, p, N, P) {
    if (typeof h == "string") {
      if (typeof p == "string" ? (P = p, p = 0, N = this.length) : typeof N == "string" && (P = N, N = this.length), P !== void 0 && typeof P != "string")
        throw new TypeError("encoding must be a string");
      if (typeof P == "string" && !c.isEncoding(P))
        throw new TypeError("Unknown encoding: " + P);
      if (h.length === 1) {
        const q = h.charCodeAt(0);
        (P === "utf8" && q < 128 || P === "latin1") && (h = q);
      }
    } else
    ...
    if (typeof h == "number")
      ...
      const q = c.isBuffer(h) ? h : c.from(h, P), ie = q.length;
      if (ie === 0)
  ...
  mt(
    ...
    "ERR_OUT_OF_RANGE",
    function(y, h, p) {
      let N = `The value of "${y}" is out of range.`, P = p;
      return Number.isInteger(p) && Math.abs(p) > 2 ** 32 ? P = xe(String(p)) : typeof p == "bigint" && (P = String(p), (p > BigInt(2) ** BigInt(32) || p < -(BigInt(2) ** BigInt(32))) && (P = xe(P)), P += "n"), N += ` It must be ${h}. Received ${P}`, N;
    },
    RangeError
  );
  function xe(y) {
  ...
  function Ne(y, h) {
    ...
    for (let q = 0; q < N; ++q) {
      if (p = y.charCodeAt(q), p > 55295 && p < 57344) {
        ...
        if (p < 56320) {
          (h -= 3) > -1 && H.push(239, 191, 189), P = p;
          continue;
        }
        p = (P - 55296 << 10 | p - 56320) + 65536;
      } else
        P && (h -= 3) > -1 && H.push(239, 191, 189);
      if (P = null, p < 128) {
        if ((h -= 1) < 0)
          break;
        H.push(p);
  ...
  function ut(y, h) {
    ...
    for (let q = 0; q < y.length && !((h -= 2) < 0); ++q)
      p = y.charCodeAt(q), N = p >> 8, P = p % 256, H.push(P), H.push(N);
    return H;
  }
  function Y(y) {
  ...
  function Q(y, h, p, N) {
    let P;
    for (P = 0; P < N && !(P + p >= h.length || P >= y.length); ++P)
      h[P + p] = y[P];
    return P;
  }
  function ee(y, h) {
...
(function(e) {
  ...
  const u = Gs, t = Fs, r = (i) => i && i.__esModule ? i : { default: i }, a = r(t), n = globalThis || void 0 || self;
...
function Ai(e, u) {
  ...
  if (uo(e))
    ...
    var r = u ? tn(e.children) : [], a = new Js(e.name, S0({}, e.attribs), r);
    ...
    var r = u ? tn(e.children) : [], n = new Qs(r);
    r.forEach(function(d) {
      return d.parent = n;
    }), t = n;
  } else if (ao(e)) {
    var r = u ? tn(e.children) : [], i = new Ks(r);
    r.forEach(function(d) {
      return d.parent = i;
    }), e["x-mode"] && (i["x-mode"] = e["x-mode"]), t = i;
  } else if (ro(e)) {
    var c = new zs(e.name, e.data);
...
(function(e) {
  var u = C && C.__createBinding || (Object.create ? function(l, g, T, v) {
    v === void 0 && (v = T);
  ...
  var M = (
    ...
    function() {
      function l(g, T, v) {
        this.decodeTree = g, this.emitCodePoint = T, this.errors = v, this.state = I.EntityStart, this.consumed = 1, this.result = 0, this.treeIndex = 0, this.excess = 1, this.decodeMode = O.Strict;
      }
      return l.prototype.startEntity = function(g) {
      ...
      }, l.prototype.addToNumericResult = function(g, T, v, D) {
        if (T !== v) {
          var k = v - T;
          this.result = this.result * Math.pow(D, k) + parseInt(g.substr(T, k), D), this.consumed += k;
        }
      }, l.prototype.stateNumericHex = function(g, T) {
        for (var v = T; T < g.length; ) {
          var D = g.charCodeAt(T);
          if (b(D) || m(D))
            T += 1;
          else
            return this.addToNumericResult(g, v, T, 16), this.emitNumericEntity(D, 3);
        }
        return this.addToNumericResult(g, v, T, 16), -1;
        ...
        for (var v = T; T < g.length; ) {
          ...
          if (b(D))
            ...
            return this.addToNumericResult(g, v, T, 10), this.emitNumericEntity(D, 2);
        }
        return this.addToNumericResult(g, v, T, 10), -1;
        ...
        for (var v = this.decodeTree, D = v[this.treeIndex], k = (D & E.VALUE_LENGTH) >> 14; T < g.length; T++, this.excess++) {
          var R = g.charCodeAt(T);
          if (this.treeIndex = B(v, D, this.treeIndex + Math.max(1, k), R), this.treeIndex < 0)
            ...
            L(R)) ? 0 : this.emitNotTerminatedNamedEntity();
          if (D = v[this.treeIndex], k = (D & E.VALUE_LENGTH) >> 14, k !== 0) {
            if (R === d.SEMI)
        ...
        var g, T = this, v = T.result, D = T.decodeTree, k = (D[v] & E.VALUE_LENGTH) >> 14;
        return this.emitNamedEntityData(v, k, this.consumed), (g = this.errors) === null || g === void 0 || g.missingSemicolonAfterCharacterReference(), this.consumed;
      }, l.prototype.emitNamedEntityData = function(g, T, v) {
        var D = this.decodeTree;
        return this.emitCodePoint(T === 1 ? D[g] & ~E.VALUE_LENGTH : D[g + 1], v), T === 3 && this.emitCodePoint(D[g + 2], v), v;
  ...
  e.EntityDecoder = M;
  function U(l) {
    var g = "", T = new M(l, function(v) {
      return g += (0, c.fromCodePoint)(v);
    });
    return function(D, k) {
...
var vf = C && C.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Dt, "__esModule", { value: !0 });
Dt.encodeNonAsciiHTML = Dt.encodeHTML = void 0;
var xf = vf(Ni), io = Fr, Nf = /[\t\n!-,./:-@[-`\f{-}$\x80-\uFFFF]/g;
function If(e) {
  return co(Nf, e);
}
Dt.encodeHTML = If;
function Df(e) {
  return co(io.xmlReplacer, e);
}
Dt.encodeNonAsciiHTML = Df;
function co(e, u) {
  for (var t = "", r = 0, a; (a = e.exec(u)) !== null; ) {
    var n = a.index;
    t += u.substring(r, n);
    var i = u.charCodeAt(n), c = xf.default.get(i);
    if (typeof c == "object") {
      if (n + 1 < u.length) {
...
(function(e) {
  ...
  function i(b, m) {
    m === void 0 && (m = a.XML);
    var A = typeof m == "number" ? m : m.level;
    if (A === a.HTML) {
      var L = typeof m == "object" ? m.mode : void 0;
      return (0, u.decodeHTML)(b, L);
    }
  ...
  function c(b, m) {
    ...
    return (A = L.mode) !== null && A !== void 0 || (L.mode = u.DecodingMode.Strict), i(b, L);
  }
  e.decodeStrict = c;
  function o(b, m) {
    m === void 0 && (m = a.XML);
    var A = typeof m == "number" ? { level: m } : m;
    return A.mode === n.UTF8 ? (0, r.escapeUTF8)(b) : A.mode === n.Attribute ? (0, r.escapeAttribute)(b) : A.mode === n.Text ? (0, r.escapeText)(b) : A.level === a.HTML ? A.mode === n.ASCII ? (0, t.encodeNonAsciiHTML)(b) : (0, t.encodeHTML)(b) : (0, r.encodeXML)(b);
  }
  e.encode = o;
  var d = Fr;
...
}, Cf = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
...
}), Sf = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), Of = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && Cf(u, e, t);
  return Sf(u, e), u;
};
Object.defineProperty(m0, "__esModule", { value: !0 });
m0.render = void 0;
var Xu = Of(Pe), qr = no, so = t0, Lf = /* @__PURE__ */ new Set([
  "style",
  "script",
  "xmp",
  "iframe",
...
function wf(e, u) {
  var t;
  if (e) {
    var r = ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) === !1 ? Pf : u.xmlMode || u.encodeEntities !== "utf8" ? qr.encodeXML : qr.escapeAttribute;
    return Object.keys(e).map(function(a) {
      var n, i, c = (n = e[a]) !== null && n !== void 0 ? n : "";
      return u.xmlMode === "foreign" && (a = (i = so.attributeNames.get(a)) !== null && i !== void 0 ? i : a), !u.emptyAttrs && !u.xmlMode && c === "" ? a : "".concat(a, '="').concat(r(c), '"');
    }).join(" ");
  }
}
...
var Mf = /* @__PURE__ */ new Set([
  ...
  "desc",
  "title"
]), kf = /* @__PURE__ */ new Set(["svg", "math"]);
function Bf(e, u) {
  var t;
  u.xmlMode === "foreign" && (e.name = (t = so.elementNames.get(e.name)) !== null && t !== void 0 ? t : e.name, e.parent && Mf.has(e.parent.name) && (u = $t($t({}, u), { xmlMode: !1 }))), !u.xmlMode && kf.has(e.name) && (u = $t($t({}, u), { xmlMode: "foreign" }));
  var r = "<".concat(e.name), a = wf(e.attribs, u);
...
function Hf(e, u) {
  var t, r = e.data || "";
  return ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) !== !1 && !(!u.xmlMode && e.parent && Lf.has(e.parent.name)) && (r = u.xmlMode || u.encodeEntities !== "utf8" ? (0, qr.encodeXML)(r) : (0, qr.escapeText)(r)), r;
}
function Ff(e) {
...
gu.getInnerHTML = Vf;
function Sr(e) {
  return Array.isArray(e) ? e.map(Sr).join("") : (0, Fu.isTag)(e) ? e.name === "br" ? `
` : Sr(e.children) : (0, Fu.isCDATA)(e) ? Sr(e.children) : (0, Fu.isText)(e) ? e.data : "";
}
gu.getText = Sr;
function Rn(e) {
  return Array.isArray(e) ? e.map(Rn).join("") : (0, Fu.hasChildren)(e) && !(0, Fu.isComment)(e) ? Rn(e.children) : (0, Fu.isText)(e) ? e.data : "";
}
gu.textContent = Rn;
function Mn(e) {
  return Array.isArray(e) ? e.map(Mn).join("") : (0, Fu.hasChildren)(e) && (e.type === $f.ElementType.Tag || (0, Fu.isCDATA)(e)) ? Mn(e.children) : (0, Fu.isText)(e) ? e.data : "";
}
gu.innerText = Mn;
var He = {};
...
He.nextElementSibling = Qf;
function Kf(e) {
  for (var u, t = e.prev; t !== null && !(0, Ii.isTag)(t); )
    u = t, t = u.prev;
  return t;
}
He.prevElementSibling = Kf;
var nu = {};
...
var la = Nu;
function r2(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), bo(e, Array.isArray(u) ? u : [u], t, r);
}
We.filter = r2;
function bo(e, u, t, r) {
  for (var a = [], n = [u], i = [0]; ; ) {
...
function ho(e, u, t) {
  ...
  for (var r = null, a = 0; a < u.length && !r; a++) {
    var n = u[a];
    if ((0, la.isTag)(n))
      e(n) ? r = n : t && n.children.length > 0 && (r = ho(e, n.children, !0));
    else
      continue;
  }
  return r;
...
function po(e, u) {
  return u.some(function(t) {
    return (0, la.isTag)(t) && (e(t) || po(e, t.children));
  });
}
We.existsOne = po;
function n2(e, u) {
...
function go(e) {
  var u = Object.keys(e).map(function(t) {
    var r = e[t];
    return Object.prototype.hasOwnProperty.call(Gr, t) ? Gr[t](r) : mo(t, r);
  });
  return u.length === 0 ? null : u.reduce(i2);
}
function c2(e, u) {
  var t = go(e);
  return t ? t(u) : !0;
...
Eu.getElements = s2;
function o2(e, u, t) {
  return t === void 0 && (t = !0), Array.isArray(u) || (u = [u]), (0, fa.findOne)(mo("id", e), u, t);
}
Eu.getElementById = o2;
function d2(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, fa.filter)(Gr.tag_name(e), u, t, r);
}
Eu.getElementsByTagName = d2;
function l2(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, fa.filter)(Gr.tag_type(e), u, t, r);
}
Eu.getElementsByTagType = l2;
var Eo = {};
(function(e) {
  ...
  function a(i, c) {
    ...
    var m = o[b - 1], A = m.children, L = o[b], I = d[b];
    return A.indexOf(L) > A.indexOf(I) ? m === c ? r.FOLLOWING | r.CONTAINED_BY : r.FOLLOWING : m === i ? r.PRECEDING | r.CONTAINS : r.PRECEDING;
  }
...
function b2(e) {
  var u = jr(E2, e);
  return u ? u.name === "feed" ? h2(u) : p2(u) : null;
}
ba.getFeed = b2;
function h2(e) {
  var u, t = e.children, r = {
    ...
    items: (0, z0.getElementsByTagName)("entry", t).map(function(i) {
      var c, o = i.children, d = { media: To(o) };
...
function To(e) {
  return (0, z0.getElementsByTagName)("media:content", e).map(function(u) {
    ...
    }, a = 0, n = m2; a < n.length; a++) {
      var i = n[a];
      t[i] && (r[i] = t[i]);
    }
    for (var c = 0, o = g2; c < o.length; c++) {
      var i = o[c];
...
function at(e, u, t) {
  return t === void 0 && (t = !1), (0, f2.textContent)((0, z0.getElementsByTagName)(e, u, t, 1)).trim();
}
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), e.hasChildren = e.isDocument = e.isComment = e.isText = e.isCDATA = e.isTag = void 0, t(gu, e), t(He, e), t(nu, e), t(We, e), t(Eu, e), t(Eo, e), t(ba, e);
  var r = Nu;
...
var It = C && C.__assign || function() {
...
}, T2 = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), _2 = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), y2 = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && T2(u, e, t);
  return _2(u, e), u;
};
...
function x2(e, u) {
  var t = v2(e) ? (u = e, void 0) : e, r = It(It(It({}, kn.default), this === null || this === void 0 ? void 0 : this._options), (0, kn.flatten)(u ?? {}));
  return _o(this, t, r);
}
Ce.html = x2;
function N2(e) {
...
Le.toggleClass = Le.removeClass = Le.addClass = Le.hasClass = Le.removeAttr = Le.val = Le.data = Le.prop = Le.attr = void 0;
var yo = Ce, pe = Rt, yc = p0, Jt = Object.prototype.hasOwnProperty, F0 = /\s+/, rn = "data-", Ac = {
  null: null,
  true: !0,
  false: !1
}, Di = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, L2 = /^{[^]*}$|^\[[^]*]$/;
function $r(e, u, t) {
  var r;
  if (!(!e || !(0, pe.isTag)(e))) {
...
function xo(e) {
  if (typeof e == "function")
    return (0, pe.domEach)(this, function(a, n) {
      (0, pe.isTag)(a) && xo.call([a], e.call(a, n, a.attribs.class || ""));
    });
...
function No(e, u) {
  if (typeof e == "function")
    return (0, pe.domEach)(this, function(E, b) {
      (0, pe.isTag)(E) && No.call([E], e.call(E, b, E.attribs.class || "", u), u);
    });
  if (!e || typeof e != "string")
    return this;
...
const Ic = /^[^\\#]?(?:\\(?:[\da-f]{1,6}\s?|.)|[\w\-\u00b0-\uFFFF])+/, H2 = /\\([\da-f]{1,6}\s?|(\s)|.)/gi, F2 = /* @__PURE__ */ new Map([
  [126, ve.Element],
  [94, ve.Start],
  [36, ve.End],
  [42, ve.Any],
...
const G2 = /* @__PURE__ */ new Set(["contains", "icontains"]);
function j2(e, u, t) {
    ...
    for (; t < u.length; ) {
      ...
      switch (b) {
        ...
        case 91: {
          n(1);
          let m, A = null;
          u.charCodeAt(t) === 124 ? m = a(1) : u.startsWith("*|", t) ? (A = "*", m = a(2)) : (m = a(0), u.charCodeAt(t) === 124 && u.charCodeAt(t + 1) !== 61 && (A = m, m = a(1))), n(0);
          let L = ve.Exists;
          const I = F2.get(u.charCodeAt(t));
          if (I) {
            if (L = I, u.charCodeAt(t + 1) !== 61)
              throw new Error("Expected `=`");
            n(2);
          } else
            u.charCodeAt(t) === 61 && (L = ve.Equals, n(1));
          let O = "", M = null;
          if (L !== "exists") {
        ...
        case 58: {
          ...
          if (u.charCodeAt(t) === 40)
            if (q2.has(m)) {
              ...
              if (A = [], t = Co(A, u, t + 1), u.charCodeAt(t) !== 41)
                throw new Error(`Missing closing parenthesis in :${m} (${u})`);
              t += 1;
            } else {
              if (A = i(), G2.has(m)) {
                const L = A.charCodeAt(0);
                L === A.charCodeAt(A.length - 1) && nn(L) && (A = A.slice(1, -1));
              }
              A = y0(A);
            }
          r.push({ type: be.Pseudo, name: m, data: A });
          break;
        }
        case 44: {
          E(), r = [], n(1);
        ...
        default: {
          ...
          if (b === 42)
            ...
            break e;
          u.charCodeAt(t) === 124 && u.charCodeAt(t + 1) !== 124 && (m = A, u.charCodeAt(t + 1) === 42 ? (A = "*", t += 2) : A = a(1)), r.push(A === "*" ? { type: be.Universal, namespace: m } : { type: be.Tag, name: A, namespace: m });
        }
      }
    }
  return E(), t;
}
const So = ["\\", '"'], Oo = [...So, "(", ")"], V2 = new Set(So.map((e) => e.charCodeAt(0))), Cc = new Set(Oo.map((e) => e.charCodeAt(0))), Vt = new Set([
  ...Oo,
  "~",
  "^",
  "$",
...
function Lo(e) {
  return e.map((u) => u.map(Y2).join("")).join(", ");
}
function Y2(e, u, t) {
  switch (e.type) {
    case be.Child:
    ...
    case be.ColumnCombinator:
      return u === 0 ? "|| " : " || ";
    case be.Universal:
      return e.namespace === "*" && u + 1 < t.length && "name" in t[u + 1] ? "" : `${Po(e.namespace)}*`;
    case be.Tag:
      return Sc(e);
    case be.PseudoElement:
      return `::${Ku(e.name, Vt)}${e.data === null ? "" : `(${Ku(e.data, Cc)})`}`;
    case be.Pseudo:
      return `:${Ku(e.name, Vt)}${e.data === null ? "" : `(${typeof e.data == "string" ? Ku(e.data, Cc) : Lo(e.data)})`}`;
    case be.Attribute: {
      if (e.name === "id" && e.action === ve.Equals && e.ignoreCase === "quirks" && !e.namespace)
        return `#${Ku(e.value, Vt)}`;
      if (e.name === "class" && e.action === ve.Element && e.ignoreCase === "quirks" && !e.namespace)
        return `.${Ku(e.value, Vt)}`;
      const r = Sc(e);
      return e.action === ve.Exists ? `[${r}]` : `[${r}${X2(e.action)}="${Ku(e.value, V2)}"${e.ignoreCase === null ? "" : e.ignoreCase ? " i" : " s"}]`;
    }
  }
}
function X2(e) {
...
function Sc(e) {
  return `${Po(e.namespace)}${Ku(e.name, Vt)}`;
}
function Po(e) {
  return e !== null ? `${e === "*" ? "*" : Ku(e, Vt)}|` : "";
}
function Ku(e, u) {
  let t = 0, r = "";
...
const W2 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  parse: $2,
  stringify: Lo
}, Symbol.toStringTag, { value: "Module" })), Q0 = /* @__PURE__ */ qs(W2);
var Bn = {}, wo = {}, Tu = {}, Mt = {}, oe = {}, lt = C && C.__extends || function() {
  var e = function(u, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, a) {
      r.__proto__ = a;
    } || function(r, a) {
...
function Si(e, u) {
  ...
  if (Go(e))
    ...
    var r = u ? cn(e.children) : [], a = new Ho(e.name, O0({}, e.attribs), r);
    r.forEach(function(o) {
      return o.parent = a;
    ...
    var r = u ? cn(e.children) : [], n = new Bo(r);
    r.forEach(function(d) {
      return d.parent = n;
    }), t = n;
  } else if (Vo(e)) {
    var r = u ? cn(e.children) : [], i = new Uo(r);
    r.forEach(function(d) {
      return d.parent = i;
    }), e["x-mode"] && (i["x-mode"] = e["x-mode"]), t = i;
  } else if ($o(e)) {
    var c = new ko(e.name, e.data);
    e["x-name"] != null && (c["x-name"] = e["x-name"], c["x-publicId"] = e["x-publicId"], c["x-systemId"] = e["x-systemId"]), t = c;
  } else
    throw new Error("Not implemented yet: ".concat(e.type));
  return t.startIndex = e.startIndex, t.endIndex = e.endIndex, e.sourceCodeLocation != null && (t.sourceCodeLocation = e.sourceCodeLocation), t;
...
var Q2 = C && C.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Ct, "__esModule", { value: !0 });
Ct.encodeNonAsciiHTML = Ct.encodeHTML = void 0;
var K2 = Q2(Pi), Xo = Yr, J2 = /[\t\n!-,./:-@[-`\f{-}$\x80-\uFFFF]/g;
function Z2(e) {
  return Wo(J2, e);
}
Ct.encodeHTML = Z2;
function eb(e) {
  return Wo(Xo.xmlReplacer, e);
}
Ct.encodeNonAsciiHTML = eb;
function Wo(e, u) {
  for (var t = "", r = 0, a; (a = e.exec(u)) !== null; ) {
    var n = a.index;
    t += u.substring(r, n);
    var i = u.charCodeAt(n), c = K2.default.get(i);
    if (typeof c == "object") {
      if (n + 1 < u.length) {
        var o = u.charCodeAt(n + 1), d = typeof c.n == "number" ? c.n === o ? c.o : void 0 : c.n.get(o);
        if (d !== void 0) {
...
var Yt = C && C.__assign || function() {
...
}, ub = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), tb = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), rb = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && ub(u, e, t);
  return tb(u, e), u;
};
Object.defineProperty(K0, "__esModule", { value: !0 });
K0.render = void 0;
var Wu = rb(Pe), Xr = Yo, zo = r0, ab = /* @__PURE__ */ new Set([
  "style",
  "script",
  "xmp",
  "iframe",
...
function ib(e, u) {
  var t;
  if (e) {
    var r = ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) === !1 ? nb : u.xmlMode || u.encodeEntities !== "utf8" ? Xr.encodeXML : Xr.escapeAttribute;
    return Object.keys(e).map(function(a) {
      var n, i, c = (n = e[a]) !== null && n !== void 0 ? n : "";
      return u.xmlMode === "foreign" && (a = (i = zo.attributeNames.get(a)) !== null && i !== void 0 ? i : a), !u.emptyAttrs && !u.xmlMode && c === "" ? a : "".concat(a, '="').concat(r(c), '"');
    }).join(" ");
  }
}
...
var sb = /* @__PURE__ */ new Set([
  ...
  "desc",
  "title"
]), ob = /* @__PURE__ */ new Set(["svg", "math"]);
function db(e, u) {
  var t;
  u.xmlMode === "foreign" && (e.name = (t = zo.elementNames.get(e.name)) !== null && t !== void 0 ? t : e.name, e.parent && sb.has(e.parent.name) && (u = Yt(Yt({}, u), { xmlMode: !1 }))), !u.xmlMode && ob.has(e.name) && (u = Yt(Yt({}, u), { xmlMode: "foreign" }));
  var r = "<".concat(e.name), a = ib(e.attribs, u);
  return a && (r += " ".concat(a)), e.children.length === 0 && (u.xmlMode ? (
    // In XML mode or foreign mode, and user hasn't explicitly turned off self-closing tags
    u.selfClosingTags !== !1
  ) : (
...
function fb(e, u) {
  var t, r = e.data || "";
  return ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) !== !1 && !(!u.xmlMode && e.parent && ab.has(e.parent.name)) && (r = u.xmlMode || u.encodeEntities !== "utf8" ? (0, Xr.encodeXML)(r) : (0, Xr.escapeText)(r)), r;
}
function bb(e) {
  return "<![CDATA[".concat(e.children[0].data, "]]>");
}
...
Tu.getInnerHTML = Eb;
function Or(e) {
  return Array.isArray(e) ? e.map(Or).join("") : (0, qu.isTag)(e) ? e.name === "br" ? `
` : Or(e.children) : (0, qu.isCDATA)(e) ? Or(e.children) : (0, qu.isText)(e) ? e.data : "";
}
Tu.getText = Or;
function Fn(e) {
  return Array.isArray(e) ? e.map(Fn).join("") : (0, qu.hasChildren)(e) && !(0, qu.isComment)(e) ? Fn(e.children) : (0, qu.isText)(e) ? e.data : "";
}
Tu.textContent = Fn;
function qn(e) {
  return Array.isArray(e) ? e.map(qn).join("") : (0, qu.hasChildren)(e) && (e.type === gb.ElementType.Tag || (0, qu.isCDATA)(e)) ? qn(e.children) : (0, qu.isText)(e) ? e.data : "";
}
Tu.innerText = qn;
var Fe = {};
...
Fe.nextElementSibling = vb;
function xb(e) {
  for (var u, t = e.prev; t !== null && !(0, wi.isTag)(t); )
    u = t, t = u.prev;
  return t;
}
Fe.prevElementSibling = xb;
var iu = {};
...
function ed(e, u, t) {
  ...
  for (var r = null, a = 0; a < u.length && !r; a++) {
    var n = u[a];
    if ((0, Ea.isTag)(n))
      e(n) ? r = n : t && n.children.length > 0 && (r = ed(e, n.children, !0));
    else
      continue;
  }
  return r;
...
function ud(e, u) {
  return u.some(function(t) {
    return (0, Ea.isTag)(t) && (e(t) || ud(e, t.children));
  });
}
ze.existsOne = ud;
function Pb(e, u) {
...
function rd(e) {
  var u = Object.keys(e).map(function(t) {
    var r = e[t];
    return Object.prototype.hasOwnProperty.call(Wr, t) ? Wr[t](r) : td(t, r);
  });
  return u.length === 0 ? null : u.reduce(wb);
}
function Rb(e, u) {
  var t = rd(e);
  return t ? t(u) : !0;
...
_u.getElements = Mb;
function kb(e, u, t) {
  return t === void 0 && (t = !0), Array.isArray(u) || (u = [u]), (0, Ta.findOne)(td("id", e), u, t);
}
_u.getElementById = kb;
function Bb(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, Ta.filter)(Wr.tag_name(e), u, t, r);
}
_u.getElementsByTagName = Bb;
function Ub(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, Ta.filter)(Wr.tag_type(e), u, t, r);
}
_u.getElementsByTagType = Ub;
var ad = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.uniqueSort = e.compareDocumentPosition = e.DocumentPosition = e.removeSubsets = void 0;
  var u = Mt;
...
function Fb(e) {
  var u = zr(Vb, e);
  return u ? u.name === "feed" ? qb(u) : Gb(u) : null;
}
_a.getFeed = Fb;
function qb(e) {
  var u, t = e.children, r = {
    type: "atom",
    items: (0, Z0.getElementsByTagName)("entry", t).map(function(i) {
      var c, o = i.children, d = { media: nd(o) };
...
function nd(e) {
  return (0, Z0.getElementsByTagName)("media:content", e).map(function(u) {
    for (var t = u.attribs, r = {
      medium: t.medium,
      isDefault: !!t.isDefault
    }, a = 0, n = jb; a < n.length; a++) {
      var i = n[a];
      t[i] && (r[i] = t[i]);
    }
    for (var c = 0, o = $b; c < o.length; c++) {
      var i = o[c];
      t[i] && (r[i] = parseInt(t[i], 10));
    }
    return t.expression && (r.expression = t.expression), r;
...
function nt(e, u, t) {
  return t === void 0 && (t = !1), (0, Hb.textContent)((0, Z0.getElementsByTagName)(e, u, t, 1)).trim();
}
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), e.hasChildren = e.isDocument = e.isComment = e.isText = e.isCDATA = e.isTag = void 0, t(Tu, e), t(Fe, e), t(iu, e), t(ze, e), t(_u, e), t(ad, e), t(_a, e);
  var r = Mt;
  Object.defineProperty(e, "isTag", { enumerable: !0, get: function() {
    return r.isTag;
  } }), Object.defineProperty(e, "isCDATA", { enumerable: !0, get: function() {
...
function Wb(e) {
  for (var u = e.map(cd), t = 1; t < e.length; t++) {
    var r = u[t];
    if (!(r < 0))
...
g0.default = Wb;
function cd(e) {
  var u, t, r = (u = id.get(e.type)) !== null && u !== void 0 ? u : -1;
  return e.type === mu.SelectorType.Attribute ? (r = (t = Xb.get(e.action)) !== null && t !== void 0 ? t : 4, e.action === mu.AttributeAction.Equals && e.name === "id" && (r = 9), e.ignoreCase && (r >>= 1)) : e.type === mu.SelectorType.Pseudo && (e.data ? e.name === "has" || e.name === "contains" ? r = 0 : Array.isArray(e.data) ? (r = Math.min.apply(Math, e.data.map(function(a) {
    return Math.min.apply(Math, a.map(cd));
  })), r < 0 && (r = 0)) : r = 2 : r = 3), r;
}
var ya = {}, Aa = {}, zb = C && C.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
...
function Tt(e, u) {
  return typeof e.ignoreCase == "boolean" ? e.ignoreCase : e.ignoreCase === "quirks" ? !!u.quirksMode : !u.xmlMode && Kb.has(e.name);
}
Aa.attributeRules = {
  ...
  element: function(e, u, t) {
    ...
    var i = new RegExp("(?:^|\\s)".concat(Pc(n), "(?:$|\\s)"), Tt(u, t) ? "i" : "");
    return function(o) {
      var d = r.getAttributeValue(o, a);
...
var Ri = {}, sd = {};
const Jb = /* @__PURE__ */ new Set([9, 10, 12, 13, 32]), wc = "0".charCodeAt(0), Zb = "9".charCodeAt(0);
function Mi(e) {
  ...
  function i() {
    const o = u;
    let d = 0;
    for (; u < e.length && e.charCodeAt(u) >= wc && e.charCodeAt(u) <= Zb; )
      d = d * 10 + (e.charCodeAt(u) - wc), u++;
    return u === o ? null : d;
  }
  function c() {
    for (; u < e.length && Jb.has(e.charCodeAt(u)); )
      u++;
  }
}
function od(e) {
...
const u3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  parse: Mi,
  sequence: e3
}, Symbol.toStringTag, { value: "Module" })), t3 = /* @__PURE__ */ qs(u3);
(function(e) {
  ...
  e.filters = {
    ...
    "nth-child": function(i, c, o) {
      ...
      return E === r.default.falseFunc ? r.default.falseFunc : E === r.default.trueFunc ? a(i, d) : function(m) {
        for (var A = d.getSiblings(m), L = 0, I = 0; I < A.length && !s(m, A[I]); I++)
          d.isTag(A[I]) && L++;
        return E(L) && i(m);
      };
    },
    "nth-last-child": function(i, c, o) {
      var d = o.adapter, s = o.equals, E = (0, t.default)(c);
      return E === r.default.falseFunc ? r.default.falseFunc : E === r.default.trueFunc ? a(i, d) : function(m) {
        for (var A = d.getSiblings(m), L = 0, I = A.length - 1; I >= 0 && !s(m, A[I]); I--)
          d.isTag(A[I]) && L++;
        return E(L) && i(m);
      };
    },
    "nth-of-type": function(i, c, o) {
      var d = o.adapter, s = o.equals, E = (0, t.default)(c);
      return E === r.default.falseFunc ? r.default.falseFunc : E === r.default.trueFunc ? a(i, d) : function(m) {
        for (var A = d.getSiblings(m), L = 0, I = 0; I < A.length; I++) {
          var O = A[I];
          if (s(m, O))
            break;
    ...
    "nth-last-of-type": function(i, c, o) {
      var d = o.adapter, s = o.equals, E = (0, t.default)(c);
      return E === r.default.falseFunc ? r.default.falseFunc : E === r.default.trueFunc ? a(i, d) : function(m) {
        for (var A = d.getSiblings(m), L = 0, I = A.length - 1; I >= 0; I--) {
          var O = A[I];
          if (s(m, O))
            break;
          d.isTag(O) && d.getName(O) === d.getName(m) && L++;
  ...
  function n(i) {
    return function(o, d, s) {
      ...
      return typeof b != "function" ? r.default.falseFunc : function(A) {
        return b(A) && o(A);
      };
    };
  }
...
(function(e) {
  var u = C && C.__spreadArray || function(d, s, E) {
    if (E || arguments.length === 2)
      for (var b = 0, m = s.length, A; b < m; b++)
        (A || !(b in s)) && (A || (A = Array.prototype.slice.call(s, 0, b)), A[b] = s[b]);
    return d.concat(A || Array.prototype.slice.call(s));
  ...
  var o = function(d, s, E, b, m) {
    var A = m(s, c(E), b);
    return A === r.default.trueFunc ? d : A === r.default.falseFunc ? r.default.falseFunc : function(L) {
      return A(L) && d(L);
    };
  };
  e.subselects = {
    ...
    not: function(d, s, E, b, m) {
      var A = m(s, c(E), b);
      return A === r.default.falseFunc ? d : A === r.default.trueFunc ? r.default.falseFunc : function(L) {
        return !A(L) && d(L);
      };
    },
    has: function(d, s, E, b, m) {
      var A = E.adapter, L = c(E);
      ...
      if (I && O !== r.default.trueFunc) {
        ...
        return function(w) {
          if (!d(w))
            return !1;
          I[0] = w;
          var F = A.getChildren(w), z = B ? u(u([], F, !0), i(w, A), !0) : F;
          return A.existsOne(M, z);
        };
      }
      return function(w) {
        return d(w) && A.existsOne(M, A.getChildren(w));
      };
    }
  };
})(xa);
(function(e) {
  ...
  function i(c, o, d, s, E) {
    var b, m = o.name, A = o.data;
    if (Array.isArray(A)) {
      if (!(m in n.subselects))
        throw new Error("Unknown pseudo-class :".concat(m, "(").concat(A, ")"));
      return n.subselects[m](c, A, d, s, E);
    }
    var L = (b = d.pseudos) === null || b === void 0 ? void 0 : b[m], I = typeof L == "string" ? L : a.aliases[m];
    if (typeof I == "string") {
      if (A != null)
    ...
    if (typeof L == "function")
      return (0, r.verifyPseudoArgs)(L, m, A, 1), function(U) {
        return L(U, A) && c(U);
      };
    if (m in t.filters)
      return t.filters[m](c, A, d, s);
    if (m in r.pseudos) {
      var M = r.pseudos[m];
      return (0, r.verifyPseudoArgs)(M, m, A, 2), function(U) {
        return M(U, d, A) && c(U);
      };
    }
...
var a3 = Aa, n3 = Ri, Pu = Q0;
function sn(e, u) {
  var t = u.getParent(e);
  return t && u.isTag(t) ? t : null;
}
function i3(e, u, t, r, a) {
  var n = t.adapter, i = t.equals;
  switch (u.type) {
    case Pu.SelectorType.PseudoElement:
      throw new Error("Pseudo-elements are not supported by css-select");
    case Pu.SelectorType.ColumnCombinator:
      throw new Error("Column combinators are not yet supported by css-select");
    case Pu.SelectorType.Attribute: {
      if (u.namespace != null)
        throw new Error("Namespaced attributes are not yet supported by css-select");
      return (!t.xmlMode || t.lowerCaseAttributeNames) && (u.name = u.name.toLowerCase()), a3.attributeRules[u.action](e, u, t);
    }
    case Pu.SelectorType.Pseudo:
      return (0, n3.compilePseudoSelector)(e, u, t, r, a);
    case Pu.SelectorType.Tag: {
      if (u.namespace != null)
    ...
    case Pu.SelectorType.Descendant: {
    ...
    case Pu.SelectorType.Universal: {
...
ya.compileGeneralSelector = i3;
var c3 = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), s3 = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), o3 = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && c3(u, e, t);
  return s3(u, e), u;
}, d3 = C && C.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(ot, "__esModule", { value: !0 });
ot.compileToken = ot.compileUnsafe = ot.compile = void 0;
var Ju = Q0, it = d3(kt), jn = o3(g0), l3 = ya, ld = xa;
function f3(e, u, t) {
  var r = fd(e, u, t);
  return (0, ld.ensureIsTag)(r, u.adapter);
}
ot.compile = f3;
function fd(e, u, t) {
  var r = typeof e == "string" ? (0, Ju.parse)(e) : e;
  return ki(r, u, t);
}
ot.compileUnsafe = fd;
function bd(e) {
  return e.type === Ju.SelectorType.Pseudo && (e.name === "scope" || Array.isArray(e.data) && e.data.some(function(u) {
    return u.some(bd);
  }));
}
var b3 = { type: Ju.SelectorType.Descendant }, h3 = {
  type: "_flexibleDescendant"
}, p3 = {
  type: Ju.SelectorType.Pseudo,
  name: "scope",
  data: null
};
function m3(e, u, t) {
  for (var r = u.adapter, a = !!(t != null && t.every(function(o) {
    ...
    return o === ld.PLACEHOLDER_ELEMENT || d && r.isTag(d);
  })), n = 0, i = e; n < i.length; n++) {
    var c = i[n];
    if (!(c.length > 0 && (0, jn.isTraversal)(c[0]) && c[0].type !== Ju.SelectorType.Descendant))
      if (a && !c.some(bd))
        c.unshift(b3);
      else
        continue;
...
function ki(e, u, t) {
  ...
  var i = !1, c = e.map(function(o) {
    if (o.length >= 2) {
      var d = o[0], s = o[1];
      d.type !== Ju.SelectorType.Pseudo || d.name !== "scope" || (a && s.type === Ju.SelectorType.Descendant ? o[1] = h3 : (s.type === Ju.SelectorType.Adjacent || s.type === Ju.SelectorType.Sibling) && (i = !0));
    }
    return g3(o, u, n);
  }).reduce(E3, it.default.falseFunc);
...
function g3(e, u, t) {
  ...
  return e.reduce(function(a, n) {
    return a === it.default.falseFunc ? it.default.falseFunc : (0, l3.compileGeneralSelector)(a, n, u, t, ki);
...
(function(e) {
  ...
  var n = r(wo), i = a(kt), c = ot, o = xa, d = function(M, U) {
    return M === U;
  }, s = {
    adapter: n,
    equals: d
  ...
  function m(M) {
    return function(B, w, F) {
      ...
      var Z = A(w, z.adapter, B.shouldTestNextSiblings);
      return M(B, Z, z);
    };
  }
  function A(M, U, B) {
    return B === void 0 && (B = !1), B && (M = L(M, U)), Array.isArray(M) ? U.removeSubsets(M) : U.getChildren(M);
  }
  e.prepareContext = A;
  function L(M, U) {
...
var hd = {}, yu = {}, Bt = {}, de = {}, ft = C && C.__extends || function() {
  var e = function(u, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, a) {
      r.__proto__ = a;
    } || function(r, a) {
...
}(), L0 = C && C.__assign || function() {
  return L0 = Object.assign || function(e) {
    for (var u, t = 1, r = arguments.length; t < r; t++) {
      u = arguments[t];
      for (var a in u)
        Object.prototype.hasOwnProperty.call(u, a) && (e[a] = u[a]);
...
function Ui(e, u) {
  ...
  if (vd(e))
    ...
    var r = u ? on(e.children) : [], a = new _d(e.name, L0({}, e.attribs), r);
    r.forEach(function(o) {
      return o.parent = a;
    }), e.namespace != null && (a.namespace = e.namespace), e["x-attribsNamespace"] && (a["x-attribsNamespace"] = L0({}, e["x-attribsNamespace"])), e["x-attribsPrefix"] && (a["x-attribsPrefix"] = L0({}, e["x-attribsPrefix"])), t = a;
  } else if (Ad(e)) {
    var r = u ? on(e.children) : [], n = new Ed(r);
    r.forEach(function(d) {
      return d.parent = n;
    }), t = n;
  } else if (Id(e)) {
    var r = u ? on(e.children) : [], i = new Td(r);
    r.forEach(function(d) {
      return d.parent = i;
    }), e["x-mode"] && (i["x-mode"] = e["x-mode"]), t = i;
  } else if (Nd(e)) {
    var c = new gd(e.name, e.data);
    e["x-name"] != null && (c["x-name"] = e["x-name"], c["x-publicId"] = e["x-publicId"], c["x-systemId"] = e["x-systemId"]), t = c;
  } else
    throw new Error("Not implemented yet: ".concat(e.type));
  return t.startIndex = e.startIndex, t.endIndex = e.endIndex, e.sourceCodeLocation != null && (t.sourceCodeLocation = e.sourceCodeLocation), t;
...
var _3 = C && C.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(St, "__esModule", { value: !0 });
St.encodeNonAsciiHTML = St.encodeHTML = void 0;
var y3 = _3(qi), Cd = Qr, A3 = /[\t\n!-,./:-@[-`\f{-}$\x80-\uFFFF]/g;
function v3(e) {
  return Sd(A3, e);
}
St.encodeHTML = v3;
function x3(e) {
  return Sd(Cd.xmlReplacer, e);
}
St.encodeNonAsciiHTML = x3;
function Sd(e, u) {
  for (var t = "", r = 0, a; (a = e.exec(u)) !== null; ) {
    var n = a.index;
    t += u.substring(r, n);
    var i = u.charCodeAt(n), c = y3.default.get(i);
    if (typeof c == "object") {
      if (n + 1 < u.length) {
        var o = u.charCodeAt(n + 1), d = typeof c.n == "number" ? c.n === o ? c.o : void 0 : c.n.get(o);
        if (d !== void 0) {
...
var Xt = C && C.__assign || function() {
...
}, N3 = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), I3 = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), D3 = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && N3(u, e, t);
  return I3(u, e), u;
};
Object.defineProperty(er, "__esModule", { value: !0 });
er.render = void 0;
var zu = D3(Pe), Kr = Dd, Od = n0, C3 = /* @__PURE__ */ new Set([
  "style",
  "script",
  "xmp",
  "iframe",
...
function O3(e, u) {
  var t;
  if (e) {
    var r = ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) === !1 ? S3 : u.xmlMode || u.encodeEntities !== "utf8" ? Kr.encodeXML : Kr.escapeAttribute;
    return Object.keys(e).map(function(a) {
      var n, i, c = (n = e[a]) !== null && n !== void 0 ? n : "";
      return u.xmlMode === "foreign" && (a = (i = Od.attributeNames.get(a)) !== null && i !== void 0 ? i : a), !u.emptyAttrs && !u.xmlMode && c === "" ? a : "".concat(a, '="').concat(r(c), '"');
    }).join(" ");
  }
}
...
var P3 = /* @__PURE__ */ new Set([
  ...
  "desc",
  "title"
]), w3 = /* @__PURE__ */ new Set(["svg", "math"]);
function R3(e, u) {
  var t;
  u.xmlMode === "foreign" && (e.name = (t = Od.elementNames.get(e.name)) !== null && t !== void 0 ? t : e.name, e.parent && P3.has(e.parent.name) && (u = Xt(Xt({}, u), { xmlMode: !1 }))), !u.xmlMode && w3.has(e.name) && (u = Xt(Xt({}, u), { xmlMode: "foreign" }));
  var r = "<".concat(e.name), a = O3(e.attribs, u);
  return a && (r += " ".concat(a)), e.children.length === 0 && (u.xmlMode ? (
    // In XML mode or foreign mode, and user hasn't explicitly turned off self-closing tags
    u.selfClosingTags !== !1
  ) : (
...
function k3(e, u) {
  var t, r = e.data || "";
  return ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) !== !1 && !(!u.xmlMode && e.parent && C3.has(e.parent.name)) && (r = u.xmlMode || u.encodeEntities !== "utf8" ? (0, Kr.encodeXML)(r) : (0, Kr.escapeText)(r)), r;
}
function B3(e) {
  return "<![CDATA[".concat(e.children[0].data, "]]>");
}
...
yu.getInnerHTML = G3;
function Lr(e) {
  return Array.isArray(e) ? e.map(Lr).join("") : (0, Gu.isTag)(e) ? e.name === "br" ? `
` : Lr(e.children) : (0, Gu.isCDATA)(e) ? Lr(e.children) : (0, Gu.isText)(e) ? e.data : "";
}
yu.getText = Lr;
function Yn(e) {
  return Array.isArray(e) ? e.map(Yn).join("") : (0, Gu.hasChildren)(e) && !(0, Gu.isComment)(e) ? Yn(e.children) : (0, Gu.isText)(e) ? e.data : "";
}
yu.textContent = Yn;
function Xn(e) {
  return Array.isArray(e) ? e.map(Xn).join("") : (0, Gu.hasChildren)(e) && (e.type === q3.ElementType.Tag || (0, Gu.isCDATA)(e)) ? Xn(e.children) : (0, Gu.isText)(e) ? e.data : "";
}
yu.innerText = Xn;
var qe = {};
...
qe.nextElementSibling = X3;
function W3(e) {
  for (var u, t = e.prev; t !== null && !(0, Gi.isTag)(t); )
    u = t, t = u.prev;
  return t;
}
qe.prevElementSibling = W3;
var cu = {};
...
var Ca = Bt;
function eh(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), Rd(e, Array.isArray(u) ? u : [u], t, r);
}
Qe.filter = eh;
function Rd(e, u, t, r) {
  for (var a = [], n = [u], i = [0]; ; ) {
...
function Md(e, u, t) {
  ...
  for (var r = null, a = 0; a < u.length && !r; a++) {
    var n = u[a];
    if ((0, Ca.isTag)(n))
      e(n) ? r = n : t && n.children.length > 0 && (r = Md(e, n.children, !0));
    else
      continue;
  }
  return r;
...
function kd(e, u) {
  return u.some(function(t) {
    return (0, Ca.isTag)(t) && (e(t) || kd(e, t.children));
  });
}
Qe.existsOne = kd;
function th(e, u) {
...
function Ud(e) {
  var u = Object.keys(e).map(function(t) {
    var r = e[t];
    return Object.prototype.hasOwnProperty.call(Jr, t) ? Jr[t](r) : Bd(t, r);
  });
  return u.length === 0 ? null : u.reduce(rh);
}
function ah(e, u) {
  var t = Ud(e);
  return t ? t(u) : !0;
...
Au.getElements = nh;
function ih(e, u, t) {
  return t === void 0 && (t = !0), Array.isArray(u) || (u = [u]), (0, Sa.findOne)(Bd("id", e), u, t);
}
Au.getElementById = ih;
function ch(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, Sa.filter)(Jr.tag_name(e), u, t, r);
}
Au.getElementsByTagName = ch;
function sh(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, Sa.filter)(Jr.tag_type(e), u, t, r);
}
Au.getElementsByTagType = sh;
var Hd = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.uniqueSort = e.compareDocumentPosition = e.DocumentPosition = e.removeSubsets = void 0;
  var u = Bt;
...
function dh(e) {
  var u = Zr(ph, e);
  return u ? u.name === "feed" ? lh(u) : fh(u) : null;
}
Oa.getFeed = dh;
function lh(e) {
  var u, t = e.children, r = {
    ...
    items: (0, tr.getElementsByTagName)("entry", t).map(function(i) {
      var c, o = i.children, d = { media: Fd(o) };
...
function Fd(e) {
  return (0, tr.getElementsByTagName)("media:content", e).map(function(u) {
    for (var t = u.attribs, r = {
      medium: t.medium,
      isDefault: !!t.isDefault
    }, a = 0, n = bh; a < n.length; a++) {
      var i = n[a];
      t[i] && (r[i] = t[i]);
    }
    for (var c = 0, o = hh; c < o.length; c++) {
      var i = o[c];
      t[i] && (r[i] = parseInt(t[i], 10));
    }
    return t.expression && (r.expression = t.expression), r;
...
function ct(e, u, t) {
  return t === void 0 && (t = !1), (0, oh.textContent)((0, tr.getElementsByTagName)(e, u, t, 1)).trim();
}
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), e.hasChildren = e.isDocument = e.isComment = e.isText = e.isCDATA = e.isTag = void 0, t(yu, e), t(qe, e), t(cu, e), t(Qe, e), t(Au, e), t(Hd, e), t(Oa, e);
  var r = Bt;
  Object.defineProperty(e, "isTag", { enumerable: !0, get: function() {
    return r.isTag;
  } }), Object.defineProperty(e, "isCDATA", { enumerable: !0, get: function() {
...
i0.getDocumentRoot = gh;
function Eh(e) {
  for (var u = [], t = [], r = 0, a = e; r < a.length; r++) {
    var n = a[r];
    n.some(mh.isFilter) ? u.push(n) : t.push(n);
  }
  return [t, u];
}
i0.groupSelectors = Eh;
(function(e) {
  var u = C && C.__assign || function() {
    ...
    if (g || arguments.length === 2)
      for (var T = 0, v = l.length, D; T < v; T++)
  ...
  var i = Q0, c = Bn, o = a(hd), d = a(kt), s = i0, E = ji, b = Bn;
  Object.defineProperty(e, "filters", { enumerable: !0, get: function() {
    return b.filters;
  } }), Object.defineProperty(e, "pseudos", { enumerable: !0, get: function() {
    return b.pseudos;
  ...
  function I(V, l, g) {
    if (g === void 0 && (g = {}), typeof l == "function")
      return V.some(l);
    var T = (0, s.groupSelectors)((0, i.parse)(l)), v = T[0], D = T[1];
    return v.length > 0 && V.some((0, c._compileToken)(v, g)) || D.some(function(k) {
      return B(k, V, g).length > 0;
    });
  }
  e.some = I;
  function O(V, l, g, T) {
    var v = typeof g == "string" ? parseInt(g, 10) : NaN;
    switch (V) {
      case "first":
      case "lt":
        return l;
      ...
      case "nth":
      case "eq":
        return isFinite(v) && Math.abs(v) < l.length ? [v < 0 ? l[l.length + v] : l[v]] : [];
      case "gt":
        return isFinite(v) ? l.slice(v + 1) : [];
      case "even":
  ...
  function U(V, l, g) {
    if (l.length === 0)
      return [];
    var T = (0, s.groupSelectors)(V), v = T[0], D = T[1], k;
    if (v.length) {
      var R = ue(l, v, g);
      if (D.length === 0)
        return R;
  ...
  function B(V, l, g) {
    ...
    if (V.some(i.isTraversal)) {
      var v = (T = g.root) !== null && T !== void 0 ? T : (0, s.getDocumentRoot)(l[0]), D = u(u({}, g), { context: l, relativeSelector: !1 });
      return V.push(A), F(v, V, D, !0, l.length);
    }
  ...
  function w(V, l, g, T) {
    if (g === void 0 && (g = {}), T === void 0 && (T = 1 / 0), typeof V == "function")
      return Z(l, V);
    var v = (0, s.groupSelectors)((0, i.parse)(V)), D = v[0], k = v[1], R = k.map(function($) {
      return F(l, $, g, !0, T);
    });
  ...
  e.select = w;
  function F(V, l, g, T, v) {
    var D = l.findIndex(E.isFilter), k = l.slice(0, D), R = l[D], $ = l.length - 1 === D ? v : 1 / 0, J = (0, E.getLimit)(R.name, R.data, $);
    if (J === 0)
      return [];
    ...
    return we.some(E.isFilter) ? F(re, we, g, !1, v) : Iu ? (
  ...
  function z(V, l, g, T) {
    var v = (0, c._compileToken)(l, g, V);
    return Z(V, v, T);
  }
  function Z(V, l, g) {
    g === void 0 && (g = 1 / 0);
    var T = (0, c.prepareContext)(V, o, l.shouldTestNextSiblings);
    return o.find(function(v) {
      return o.isTag(v) && l(v);
    }, T, !0, g);
  }
  function ue(V, l, g) {
    ...
    if (T.length === 0)
      return T;
    var v = (0, c._compileToken)(l, g);
    return v === d.trueFunc ? T : T.filter(v);
  }
})(Io);
var Th = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), _h = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), yh = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && Th(u, e, t);
  return _h(u, e), u;
...
var La = Nu, E0 = yh(Io), wu = Rt, Ah = Ce, $u = p0, vh = /^\s*[~+]/;
function xh(e) {
  var u;
  if (!e)
    return this._make([]);
  var t = this.toArray();
  if (typeof e != "string") {
    var r = (0, wu.isCheerio)(e) ? e.toArray() : [e];
    return this._make(r.filter(function(i) {
      return t.some(function(c) {
        return (0, Ah.contains)(c, i);
      });
    }));
  }
  var a = vh.test(e) ? t : this.children().toArray(), n = {
    context: t,
...
function Yi(e) {
  ...
  var r = null, a = $i(function(n, i) {
    var c = [];
    return (0, wu.domEach)(i, function(o) {
...
K.parent = Vi(function(e) {
  var u = e.parent;
  return u && !(0, La.isDocument)(u) ? u : null;
}, T0);
K.parents = rr(function(e) {
  for (var u = []; e.parent && !(0, La.isDocument)(e.parent); )
...
function Nh(e) {
  ...
  return (0, wu.domEach)(this, function(n) {
    for (; n && (0, wu.isTag)(n); ) {
      if (a(n, 0)) {
...
K.next = Vi(function(e) {
  return (0, $u.nextElementSibling)(e);
});
K.nextAll = rr(function(e) {
  for (var u = []; e.next; )
    e = e.next, (0, wu.isTag)(e) && u.push(e);
  return u;
}, T0);
...
K.prev = Vi(function(e) {
  return (0, $u.prevElementSibling)(e);
});
K.prevAll = rr(function(e) {
  for (var u = []; e.prev; )
    e = e.prev, (0, wu.isTag)(e) && u.push(e);
  return u;
}, T0);
...
K.siblings = rr(function(e) {
  return (0, $u.getSiblings)(e).filter(function(u) {
    return (0, wu.isTag)(u) && u !== e;
  });
}, $u.uniqueSort);
K.children = rr(function(e) {
  return (0, $u.getChildren)(e).filter(wu.isTag);
}, T0);
function Ih() {
  var e = this.toArray().reduce(function(u, t) {
    return (0, La.hasChildren)(t) ? u.concat(t.children) : u;
  }, []);
  return this._make(e);
}
K.contents = Ih;
...
function Oh(e) {
  var u = this.toArray();
  return typeof e == "string" ? E0.some(u.filter(wu.isTag), e, this.options) : e ? u.some(ar(e)) : !1;
}
K.is = Oh;
function Lh(e) {
  var u = this.toArray();
...
function Uh(e) {
  var u, t;
  return e == null ? (u = this.parent().children(), t = this[0]) : typeof e == "string" ? (u = this._make(e), t = this[0]) : (u = this, t = (0, wu.isCheerio)(e) ? e[0] : e), Array.prototype.indexOf.call(u, t);
}
K.index = Uh;
function Hh(e, u) {
...
K.end = Fh;
function qh(e, u) {
  var t = this._make(e, u), r = (0, $u.uniqueSort)(Wn(Wn([], this.get(), !0), t.get(), !0));
  return this._make(r);
}
K.add = qh;
function Gh(e) {
...
function $h(e) {
  return function(t, r, a, n) {
    if (typeof Ou.Buffer < "u" && Ou.Buffer.isBuffer(t) && (t = t.toString()), typeof t == "string")
      return e(t, r, a, n);
    var i = t;
...
function qd(e, u) {
  ...
  for (var r = 0; r < t.length; r++) {
    var a = t[r];
    a.parent && a.parent.children !== t && (0, jh.removeElement)(a), u ? (a.prev = t[r - 1] || null, a.next = t[r + 1] || null) : a.prev = a.next = null, a.parent = u;
  }
  return u;
}
Ot.update = qd;
var Vh = C && C.__spreadArray || function(e, u, t) {
  if (t || arguments.length === 2)
    for (var r = 0, a = u.length, n; r < a; r++)
      (n || !(r in u)) && (n || (n = Array.prototype.slice.call(u, 0, r)), n[r] = u[r]);
  return e.concat(n || Array.prototype.slice.call(u));
...
var Vu = Nu, c0 = Ot, kc = Ce, Me = Rt, Yh = p0;
function Xh(e, u) {
  var t = this;
...
function bt(e, u, t, r, a) {
  for (var n, i, c = Vh([
    ...
    if (b) {
      var m = b.children, A = m.indexOf(E);
      A > -1 && (b.children.splice(A, 1), a === b && u > A && c[0]--);
    }
...
ne.prependTo = zh;
ne.append = Gd(function(e, u, t) {
  bt(u, u.length, 0, e, t);
});
ne.prepend = Gd(function(e, u, t) {
  bt(u, 0, 0, e, t);
});
function jd(e) {
  return function(u) {
...
ne.wrapInner = jd(function(e, u, t) {
  (0, Vu.hasChildren)(e) && ((0, c0.update)(e.children, u), (0, c0.update)(t, e));
});
function Qh(e) {
  var u = this;
...
function t6(e) {
  ...
  return (0, Me.domEach)(u, function(t) {
    (0, Yh.removeElement)(t), t.prev = t.next = t.parent = null;
  }), this;
}
ne.remove = t6;
function r6(e) {
...
function a6() {
  return (0, Me.domEach)(this, function(e) {
    (0, Vu.hasChildren)(e) && (e.children.forEach(function(u) {
...
function n6(e) {
  ...
  if (e === void 0) {
    var t = this[0];
    return !t || !(0, Vu.hasChildren)(t) ? null : this._render(t.children);
  }
  return (0, Me.domEach)(this, function(r) {
    if ((0, Vu.hasChildren)(r)) {
...
function $d(e, u, t, r) {
  if (typeof u == "string") {
    var a = Vd(e), n = typeof t == "function" ? t.call(e, r, a[u]) : t;
    n === "" ? delete a[u] : n != null && (a[u] = n), e.attribs.style = d6(a);
  } else
...
function p6() {
  ...
  return this.map(function(u, t) {
    var r = e._make(t);
    return (0, f6.isTag)(t) && t.name === "form" ? r.find(Bc).toArray() : r.filter(Bc).toArray();
  }).filter(
...
ha.Cheerio = void 0;
var E6 = nr(Le), T6 = nr(K), _6 = nr(ne), y6 = nr(Pa), A6 = nr(s0), ir = (
  /** @class */
  function() {
    function e(u, t, r) {
...
Object.assign(ir.prototype, E6, T6, _6, y6, A6);
var v6 = C && C.__extends || function() {
  var e = function(u, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, a) {
      r.__proto__ = a;
    } || function(r, a) {
...
}, x6 = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), N6 = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), Yd = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && x6(u, e, t);
  return N6(u, e), u;
};
Object.defineProperty(ca, "__esModule", { value: !0 });
ca.getLoad = void 0;
var dn = Yd(h0), I6 = Yd(Ce), D6 = ha, A0 = Rt;
function C6(e, u) {
  return function t(r, a, n) {
    ...
    var i = Wt(Wt({}, dn.default), (0, dn.flatten)(a)), c = e(r, i, n, null), o = (
      ...
      function(s) {
        ...
        }, E.prototype._parse = function(b, m, A, L) {
          return e(b, m, A, L);
    ...
    function d(s, E, b, m) {
      if (b === void 0 && (b = c), s && (0, A0.isCheerio)(s))
        return s;
      var A = Wt(Wt({}, i), (0, dn.flatten)(m)), L = typeof b == "string" ? [e(b, A, !1, null)] : "length" in b ? b : [b], I = (0, A0.isCheerio)(L) ? L : new o(L, null, A);
      if (I._root = I, !s)
        return new o(void 0, I, A);
      var O = typeof s == "string" && (0, A0.isHtml)(s) ? (
        // $(<html>)
        e(s, A, !1, null).children
      ) : S6(s) ? (
        // $(dom)
        [s]
      ) : Array.isArray(s) ? (
...
const Xe = Ra, ln = cr, O6 = 65536;
class L6 {
  constructor(u) {
    this.handler = u, this.html = "", this.pos = -1, this.lastGapPos = -2, this.gapStack = [], this.skipNextNewLine = !1, this.lastChunkWritten = !1, this.endOfChunkHit = !1, this.bufferWaterline = O6, this.isEol = !1, this.lineStartPos = 0, this.droppedBufferSize = 0, this.line = 1, this.lastErrOffset = -1;
  }
...
Lt.Tokenizer = Lt.TokenizerMode = void 0;
const P6 = wa, _ = Ra, eu = Ma, ku = Xd, G = cr, fn = et, w6 = /* @__PURE__ */ new Map([
  [128, 8364],
  [130, 8218],
  [131, 402],
  [132, 8222],
...
function Hc(e) {
  return Qd(e) || e === _.CODE_POINTS.SOLIDUS || e === _.CODE_POINTS.GREATER_THAN_SIGN;
}
let B6 = class {
  constructor(u, t) {
    this.options = u, this.handler = t, this.paused = !1, this.inLoop = !1, this.inForeignNode = !1, this.lastStartTagName = "", this.active = !1, this.state = x.DATA, this.returnState = x.DATA, this.charRefCode = -1, this.consumedAfterSnapshot = -1, this.currentCharacterToken = null, this.currentToken = null, this.currentAttr = { name: "", value: "" }, this.preprocessor = new P6.Preprocessor(t), this.currentLocation = this.getCurrentLocation(-1);
  }
  //Errors
  _err(u) {
    var t, r;
  ...
  _emitCodePoint(u) {
    const t = Qd(u) ? eu.TokenType.WHITESPACE_CHARACTER : u === _.CODE_POINTS.NULL ? eu.TokenType.NULL_CHARACTER : eu.TokenType.CHARACTER;
  ...
  _matchNamedCharacterReference(u) {
    let t = null, r = 0, a = !1;
    for (let n = 0, i = ku.htmlDecodeTree[0]; n >= 0 && (n = (0, ku.determineBranch)(ku.htmlDecodeTree, i, n + 1, u), !(n < 0)); u = this._consume()) {
      r += 1, i = ku.htmlDecodeTree[n];
      const c = i & ku.BinTrieFlags.VALUE_LENGTH;
      if (c) {
        const o = (c >> 14) - 1;
        if (u !== _.CODE_POINTS.SEMICOLON && this._isCharacterReferenceInAttribute() && k6(this.preprocessor.peek(1)) ? (t = [_.CODE_POINTS.AMPERSAND], n += o) : (t = o === 0 ? [ku.htmlDecodeTree[n] & ~ku.BinTrieFlags.VALUE_LENGTH] : o === 1 ? [ku.htmlDecodeTree[++n]] : [ku.htmlDecodeTree[++n], ku.htmlDecodeTree[++n]], r = 0, a = u !== _.CODE_POINTS.SEMICOLON), o === 0) {
          this._consume();
          break;
        }
      }
  ...
  _stateRcdataEndTagOpen(u) {
    rt(u) ? (this.state = x.RCDATA_END_TAG_NAME, this._stateRcdataEndTagName(u)) : (this._emitChars("</"), this.state = x.RCDATA, this._stateRcdata(u));
  }
  ...
  _stateRawtextEndTagOpen(u) {
    rt(u) ? (this.state = x.RAWTEXT_END_TAG_NAME, this._stateRawtextEndTagName(u)) : (this._emitChars("</"), this.state = x.RAWTEXT, this._stateRawtext(u));
  }
  ...
  _stateScriptDataEndTagOpen(u) {
    rt(u) ? (this.state = x.SCRIPT_DATA_END_TAG_NAME, this._stateScriptDataEndTagName(u)) : (this._emitChars("</"), this.state = x.SCRIPT_DATA, this._stateScriptData(u));
  }
  ...
  _stateScriptDataEscapedLessThanSign(u) {
    u === _.CODE_POINTS.SOLIDUS ? this.state = x.SCRIPT_DATA_ESCAPED_END_TAG_OPEN : rt(u) ? (this._emitChars("<"), this.state = x.SCRIPT_DATA_DOUBLE_ESCAPE_START, this._stateScriptDataDoubleEscapeStart(u)) : (this._emitChars("<"), this.state = x.SCRIPT_DATA_ESCAPED, this._stateScriptDataEscaped(u));
  }
  // Script data escaped end tag open state
  //------------------------------------------------------------------
  _stateScriptDataEscapedEndTagOpen(u) {
    rt(u) ? (this.state = x.SCRIPT_DATA_ESCAPED_END_TAG_NAME, this._stateScriptDataEscapedEndTagName(u)) : (this._emitChars("</"), this.state = x.SCRIPT_DATA_ESCAPED, this._stateScriptDataEscaped(u));
  }
  ...
  _stateNumericCharacterReference(u) {
    this.charRefCode = 0, u === _.CODE_POINTS.LATIN_SMALL_X || u === _.CODE_POINTS.LATIN_CAPITAL_X ? this.state = x.HEXADEMICAL_CHARACTER_REFERENCE_START : P0(u) ? (this.state = x.DECIMAL_CHARACTER_REFERENCE, this._stateDecimalCharacterReference(u)) : (this._err(G.ERR.absenceOfDigitsInNumericCharacterReference), this._flushCodePointConsumedAsCharacterReference(_.CODE_POINTS.AMPERSAND), this._flushCodePointConsumedAsCharacterReference(_.CODE_POINTS.NUMBER_SIGN), this._reconsumeInState(this.returnState, u));
  }
  // Hexademical character reference start state
  //------------------------------------------------------------------
  _stateHexademicalCharacterReferenceStart(u) {
    M6(u) ? (this.state = x.HEXADEMICAL_CHARACTER_REFERENCE, this._stateHexademicalCharacterReference(u)) : (this._err(G.ERR.absenceOfDigitsInNumericCharacterReference), this._flushCodePointConsumedAsCharacterReference(_.CODE_POINTS.AMPERSAND), this._flushCodePointConsumedAsCharacterReference(_.CODE_POINTS.NUMBER_SIGN), this._unconsume(2), this.state = this.returnState);
  }
  // Hexademical character reference state
  //------------------------------------------------------------------
  _stateHexademicalCharacterReference(u) {
    Wd(u) ? this.charRefCode = this.charRefCode * 16 + u - 55 : zd(u) ? this.charRefCode = this.charRefCode * 16 + u - 87 : P0(u) ? this.charRefCode = this.charRefCode * 16 + u - 48 : u === _.CODE_POINTS.SEMICOLON ? this.state = x.NUMERIC_CHARACTER_REFERENCE_END : (this._err(G.ERR.missingSemicolonAfterCharacterReference), this.state = x.NUMERIC_CHARACTER_REFERENCE_END, this._stateNumericCharacterReferenceEnd(u));
  }
  // Decimal character reference state
  //------------------------------------------------------------------
  _stateDecimalCharacterReference(u) {
    P0(u) ? this.charRefCode = this.charRefCode * 10 + u - 48 : u === _.CODE_POINTS.SEMICOLON ? this.state = x.NUMERIC_CHARACTER_REFERENCE_END : (this._err(G.ERR.missingSemicolonAfterCharacterReference), this.state = x.NUMERIC_CHARACTER_REFERENCE_END, this._stateNumericCharacterReferenceEnd(u));
  }
  ...
  _stateNumericCharacterReferenceEnd(u) {
    if (this.charRefCode === _.CODE_POINTS.NULL)
      ...
      const t = w6.get(this.charRefCode);
...
const j = et, Kd = /* @__PURE__ */ new Set([j.TAG_ID.DD, j.TAG_ID.DT, j.TAG_ID.LI, j.TAG_ID.OPTGROUP, j.TAG_ID.OPTION, j.TAG_ID.P, j.TAG_ID.RB, j.TAG_ID.RP, j.TAG_ID.RT, j.TAG_ID.RTC]), Fc = /* @__PURE__ */ new Set([
  ...Kd,
  j.TAG_ID.CAPTION,
  j.TAG_ID.COLGROUP,
  j.TAG_ID.TBODY,
...
]), U6 = [j.TAG_ID.H1, j.TAG_ID.H2, j.TAG_ID.H3, j.TAG_ID.H4, j.TAG_ID.H5, j.TAG_ID.H6], H6 = [j.TAG_ID.TR, j.TAG_ID.TEMPLATE, j.TAG_ID.HTML], F6 = [j.TAG_ID.TBODY, j.TAG_ID.TFOOT, j.TAG_ID.THEAD, j.TAG_ID.TEMPLATE, j.TAG_ID.HTML], q6 = [j.TAG_ID.TABLE, j.TAG_ID.TEMPLATE, j.TAG_ID.HTML], G6 = [j.TAG_ID.TD, j.TAG_ID.TH];
class j6 {
  ...
  popUntilNumberedHeaderPopped() {
    this.popUntilPopped(U6, j.NS.HTML);
  }
  popUntilTableCellPopped() {
    this.popUntilPopped(G6, j.NS.HTML);
  }
  ...
  clearBackToTableContext() {
    this.clearBackTo(q6, j.NS.HTML);
  }
  clearBackToTableBodyContext() {
    this.clearBackTo(F6, j.NS.HTML);
  }
  clearBackToTableRowContext() {
    this.clearBackTo(H6, j.NS.HTML);
  }
  remove(u) {
    const t = this._indexOf(u);
    ...
    _getNoahArkConditionCandidates(i, c) {
      ...
      for (let b = 0; b < this.entries.length; b++) {
        ...
        if (m.type === t.Marker)
          break;
        const { element: A } = m;
        if (this.treeAdapter.getTagName(A) === s && this.treeAdapter.getNamespaceURI(A) === E) {
          const L = this.treeAdapter.getAttrList(A);
          L.length === d && o.push({ idx: b, attrs: L });
        }
      }
      return o;
    }
...
const Gt = et, Zd = "html", $6 = "about:legacy-compat", V6 = "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd", e1 = [
  ...
  "html"
]), u1 = ["-//w3c//dtd xhtml 1.0 frameset//", "-//w3c//dtd xhtml 1.0 transitional//"], W6 = [
  ...u1,
  "-//w3c//dtd html 4.01 frameset//",
  "-//w3c//dtd html 4.01 transitional//"
];
...
function z6(e) {
  return e.name === Zd && e.publicId === null && (e.systemId === null || e.systemId === $6);
}
d0.isConforming = z6;
function Q6(e) {
  if (e.name !== Zd)
  ...
  const { systemId: u } = e;
  if (u && u.toLowerCase() === V6)
    return Gt.DOCUMENT_MODE.QUIRKS;
  let { publicId: t } = e;
  if (t !== null) {
    if (t = t.toLowerCase(), X6.has(t))
      return Gt.DOCUMENT_MODE.QUIRKS;
    let r = u === null ? Y6 : e1;
    if (qc(t, r))
      return Gt.DOCUMENT_MODE.QUIRKS;
    if (r = u === null ? u1 : W6, qc(t, r))
      return Gt.DOCUMENT_MODE.LIMITED_QUIRKS;
  }
  return Gt.DOCUMENT_MODE.NO_QUIRKS;
}
d0.getDocumentMode = Q6;
var Qi = {};
(function(e) {
  ...
  function L(I, O, M, U) {
    return (!U || U === u.NS.HTML) && A(I, O, M) || (!U || U === u.NS.MATHML) && m(I, O);
  }
  e.isIntegrationPoint = L;
})(Qi);
Object.defineProperty(G0, "__esModule", { value: !0 });
G0.Parser = void 0;
const Ke = Lt, K6 = ka, Gc = Jd, J6 = Ba, jc = d0, Hu = Qi, $e = cr, t1 = Ra, f = et, Re = Ma, Z6 = "hidden", ep = 8, up = 3;
var S;
(function(e) {
...
let rp = class {
  ...
  _err(u, t, r) {
    ...
    if (!this.onParseError)
      return;
    const n = (a = u.location) !== null && a !== void 0 ? a : tp, i = {
      code: t,
  ...
  _isIntegrationPoint(u, t, r) {
    ...
    return Hu.isIntegrationPoint(u, a, n, r);
  }
   ...
   */
  _processStartTag(u) {
    this.shouldProcessStartTagTokenInForeignContent(u) ? R4(this, u) : this._startTagOutsideForeignContent(u);
  }
  ...
  onEndTag(u) {
    this.skipNextNewLine = !1, this.currentToken = u, this.currentNotInHTML ? M4(this, u) : this._endTagOutsideForeignContent(u);
  }
  ...
  onWhitespaceCharacter(u) {
    if (this.skipNextNewLine && (this.skipNextNewLine = !1, u.chars.charCodeAt(0) === t1.CODE_POINTS.LINE_FEED)) {
      if (u.chars.length === 1)
        return;
...
function ap(e, u) {
  ...
  return t ? e.openElements.contains(t.element) ? e.openElements.hasInScope(u.tagID) || (t = null) : (e.activeFormattingElements.removeEntry(t), t = null) : s1(e, u), t;
}
function np(e, u) {
...
function ip(e, u, t) {
  ...
  for (let n = 0, i = a; i !== t; n++, i = a) {
    ...
    const c = e.activeFormattingElements.getElementEntry(i), o = c && n >= up;
    !c || o ? (o && e.activeFormattingElements.removeEntry(c), e.openElements.remove(i)) : (i = cp(e, c), r === u && (e.activeFormattingElements.bookmark = c), e.treeAdapter.detachNode(r), e.treeAdapter.appendChild(i, r), r = i);
  }
  return r;
}
function cp(e, u) {
...
function Ki(e, u) {
  for (let t = 0; t < ep; t++) {
    ...
    const n = ip(e, a, r.element), i = e.openElements.getCommonAncestor(r.element);
    e.treeAdapter.detachNode(n), i && sp(e, i, n), op(e, a, r);
  }
}
function Jn(e, u) {
...
function _p(e, u) {
  switch (u.tagID) {
    ...
    case f.TAG_ID.TEMPLATE:
    case f.TAG_ID.TITLE: {
      e._err(u, $e.ERR.abandonedHeadElementChild), e.openElements.push(e.headElement, f.TAG_ID.HEAD), Ru(e, u), e.openElements.remove(e.headElement);
      break;
    }
    case f.TAG_ID.HEAD: {
      e._err(u, $e.ERR.misplacedStartTagForHeadElement);
...
function c1(e) {
  ...
  return u != null && u.toLowerCase() === Z6;
}
function Bp(e, u) {
  e._reconstructActiveFormattingElements(), e._appendElement(u, f.NS.HTML), c1(u) || (e.framesetOk = !1), u.ackSelfClosing = !0;
}
function Up(e, u) {
  e._appendElement(u, f.NS.HTML), u.ackSelfClosing = !0;
}
...
function Fp(e, u) {
  u.tagName = f.TAG_NAMES.IMG, u.tagID = f.TAG_ID.IMG, i1(e, u);
}
function qp(e, u) {
...
function Wp(e, u) {
  e._reconstructActiveFormattingElements(), Hu.adjustTokenMathMLAttrs(u), Hu.adjustTokenXMLAttrs(u), u.selfClosing ? e._appendElement(u, f.NS.MATHML) : e._insertElement(u, f.NS.MATHML), u.ackSelfClosing = !0;
}
function zp(e, u) {
  e._reconstructActiveFormattingElements(), Hu.adjustTokenSVGAttrs(u), Hu.adjustTokenXMLAttrs(u), u.selfClosing ? e._appendElement(u, f.NS.SVG) : e._insertElement(u, f.NS.SVG), u.ackSelfClosing = !0;
}
function Yc(e, u) {
...
function Kp(e, u) {
  e.openElements.hasInScope(f.TAG_ID.BODY) && (e.insertionMode = S.AFTER_BODY, g1(e, u));
}
function Jp(e, u) {
  const t = u.tagID;
...
function o1(e, u) {
  e.tmplInsertionModeStack.length > 0 ? m1(e, u) : Ji(e, u);
}
function i4(e, u) {
  var t;
...
function bn(e, u) {
  if (r1.has(e.openElements.currentTagId))
...
function h4(e, u) {
  c1(u) ? e._appendElement(u, f.NS.HTML) : sr(e, u), u.ackSelfClosing = !0;
}
function p4(e, u) {
...
const f1 = /* @__PURE__ */ new Set([f.TAG_ID.CAPTION, f.TAG_ID.COL, f.TAG_ID.COLGROUP, f.TAG_ID.TBODY, f.TAG_ID.TD, f.TAG_ID.TFOOT, f.TAG_ID.TH, f.TAG_ID.THEAD, f.TAG_ID.TR]);
function m4(e, u) {
  const t = u.tagID;
  f1.has(t) ? e.openElements.hasInTableScope(f.TAG_ID.CAPTION) && (e.openElements.generateImpliedEndTags(), e.openElements.popUntilTagNamePopped(f.TAG_ID.CAPTION), e.activeFormattingElements.clearToLastMarker(), e.insertionMode = S.IN_TABLE, l0(e, u)) : Ye(e, u);
}
function g4(e, u) {
  const t = u.tagID;
  switch (t) {
...
function T4(e, u) {
  const t = u.tagID;
  f1.has(t) ? (e.openElements.hasInTableScope(f.TAG_ID.TD) || e.openElements.hasInTableScope(f.TAG_ID.TH)) && (e._closeTableCell(), qa(e, u)) : Ye(e, u);
}
function _4(e, u) {
  const t = u.tagID;
  switch (t) {
    ...
    case f.TAG_ID.THEAD:
    case f.TAG_ID.TR: {
      e.openElements.hasInTableScope(t) && (e._closeTableCell(), b1(e, u));
      break;
    }
    case f.TAG_ID.BODY:
    case f.TAG_ID.CAPTION:
...
function y4(e, u) {
  const t = u.tagID;
  t === f.TAG_ID.CAPTION || t === f.TAG_ID.TABLE || t === f.TAG_ID.TBODY || t === f.TAG_ID.TFOOT || t === f.TAG_ID.THEAD || t === f.TAG_ID.TR || t === f.TAG_ID.TD || t === f.TAG_ID.TH ? (e.openElements.popUntilTagNamePopped(f.TAG_ID.SELECT), e._resetInsertionMode(), e._processStartTag(u)) : h1(e, u);
}
function A4(e, u) {
  const t = u.tagID;
  t === f.TAG_ID.CAPTION || t === f.TAG_ID.TABLE || t === f.TAG_ID.TBODY || t === f.TAG_ID.TFOOT || t === f.TAG_ID.THEAD || t === f.TAG_ID.TR || t === f.TAG_ID.TD || t === f.TAG_ID.TH ? e.openElements.hasInTableScope(t) && (e.openElements.popUntilTagNamePopped(f.TAG_ID.SELECT), e._resetInsertionMode(), e.onEndTag(u)) : p1(e, u);
}
function v4(e, u) {
  switch (u.tagID) {
    case f.TAG_ID.BASE:
...
function O4(e, u) {
  u.tagID === f.TAG_ID.HTML ? Ye(e, u) : Pr(e, u);
}
function Pr(e, u) {
  e.insertionMode = S.IN_BODY, Ua(e, u);
}
...
function P4(e, u) {
  u.chars = t1.REPLACEMENT_CHARACTER, e._insertCharacters(u);
}
function w4(e, u) {
...
function R4(e, u) {
  if (Hu.causesExit(u))
    ...
    r === f.NS.MATHML ? Hu.adjustTokenMathMLAttrs(u) : r === f.NS.SVG && (Hu.adjustTokenSVGTagName(u), Hu.adjustTokenSVGAttrs(u)), Hu.adjustTokenXMLAttrs(u), u.selfClosing ? e._appendElement(u, r) : e._insertElement(u, r), u.ackSelfClosing = !0;
  }
}
function M4(e, u) {
...
const Ee = et, _1 = T1, k4 = Ba, B4 = /* @__PURE__ */ new Set([
  Ee.TAG_NAMES.AREA,
  Ee.TAG_NAMES.BASE,
...
function y1(e, u) {
  return u.treeAdapter.isElementNode(e) && u.treeAdapter.getNamespaceURI(e) === Ee.NS.HTML && B4.has(u.treeAdapter.getTagName(e));
}
const A1 = { treeAdapter: k4.defaultTreeAdapter, scriptingEnabled: !0 };
function U4(e, u) {
  const t = Object.assign(Object.assign({}, A1), u);
  return y1(e, t) ? "" : v1(e, t);
}
f0.serialize = U4;
function H4(e, u) {
  const t = Object.assign(Object.assign({}, A1), u);
...
function x1(e, u) {
  return u.treeAdapter.isElementNode(e) ? F4(e, u) : u.treeAdapter.isTextNode(e) ? G4(e, u) : u.treeAdapter.isCommentNode(e) ? j4(e, u) : u.treeAdapter.isDocumentTypeNode(e) ? $4(e, u) : "";
}
function F4(e, u) {
  const t = u.treeAdapter.getTagName(e);
  return `<${t}${q4(e, u)}>${y1(e, u) ? "" : `${v1(e, u)}</${t}>`}`;
}
function q4(e, { treeAdapter: u }) {
  let t = "";
  for (const r of u.getAttrList(e)) {
    ...
    t += `="${(0, _1.escapeAttribute)(r.value)}"`;
  }
  return t;
}
function G4(e, u) {
  const { treeAdapter: t } = u, r = t.getTextNodeContent(e), a = t.getParentNode(e), n = a && t.isElementNode(a) && t.getTagName(a);
  return n && t.getNamespaceURI(a) === Ee.NS.HTML && (0, Ee.hasUnescapedText)(n, u.scriptingEnabled) ? r : (0, _1.escapeText)(r);
}
function j4(e, { treeAdapter: u }) {
  return `<!--${u.getCommentNodeContent(e)}-->`;
}
function $4(e, { treeAdapter: u }) {
...
(function(e) {
  ...
  Object.defineProperty(e, "ErrorCodes", { enumerable: !0, get: function() {
    return n.ERR;
  } }), e.foreignContent = Qi, e.html = et, e.Token = Ma;
  var i = Lt;
...
var N1 = {}, I1 = {}, le = {}, ht = C && C.__extends || function() {
  var e = function(u, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, a) {
      r.__proto__ = a;
    } || function(r, a) {
...
function uc(e, u) {
  ...
  if (M1(e))
    ...
    var r = u ? hn(e.children) : [], a = new P1(e.name, U0({}, e.attribs), r);
    r.forEach(function(o) {
      return o.parent = a;
    ...
    var r = u ? hn(e.children) : [], n = new O1(r);
    r.forEach(function(d) {
      return d.parent = n;
    }), t = n;
  } else if (U1(e)) {
    var r = u ? hn(e.children) : [], i = new L1(r);
    r.forEach(function(d) {
      return d.parent = i;
    }), e["x-mode"] && (i["x-mode"] = e["x-mode"]), t = i;
  } else if (B1(e)) {
    var c = new S1(e.name, e.data);
    e["x-name"] != null && (c["x-name"] = e["x-name"], c["x-publicId"] = e["x-publicId"], c["x-systemId"] = e["x-systemId"]), t = c;
  } else
    throw new Error("Not implemented yet: ".concat(e.type));
  return t.startIndex = e.startIndex, t.endIndex = e.endIndex, e.sourceCodeLocation != null && (t.sourceCodeLocation = e.sourceCodeLocation), t;
  ...
  e.serializeDoctypeContent = n, e.adapter = {
    ...
    createElement(i, c, o) {
      ...
      for (let m = 0; m < o.length; m++) {
        const A = o[m].name;
        d[A] = o[m].value, s[A] = o[m].namespace, E[A] = o[m].prefix;
      }
...
var Y4 = C && C.__spreadArray || function(e, u, t) {
  if (t || arguments.length === 2)
    for (var r = 0, a = u.length, n; r < a; r++)
      (n || !(r in u)) && (n || (n = Array.prototype.slice.call(u, 0, r)), n[r] = u[r]);
  return e.concat(n || Array.prototype.slice.call(u));
...
var X4 = Nu, ei = q0, H1 = N1;
function W4(e, u, t, r) {
  var a = {
    scriptingEnabled: typeof u.scriptingEnabled == "boolean" ? u.scriptingEnabled : !0,
    treeAdapter: H1.adapter,
    sourceCodeLocationInfo: u.sourceCodeLocationInfo
  };
  return t ? (0, ei.parse)(e, a) : (0, ei.parseFragment)(r, e, a);
}
o0.parseWithParse5 = W4;
var z4 = { treeAdapter: H1.adapter };
function Q4(e) {
  for (var u, t = ("length" in e) ? e : [e], r = 0; r < t.length; r += 1) {
    var a = t[r];
    (0, X4.isDocument)(a) && (u = Array.prototype.splice).call.apply(u, Y4([t, r, 1], a.children, !1));
  }
  for (var n = "", r = 0; r < t.length; r += 1) {
    var a = t[r];
    n += (0, ei.serializeOuter)(a, z4);
  }
  return n;
}
o0.renderWithParse5 = Q4;
var F1 = {}, $0 = {}, tc = {}, V0 = {}, rc = {};
...
(function(e) {
  ...
  var s = {
    ...
    function() {
      function b(m, A) {
        var L = m.xmlMode, I = L === void 0 ? !1 : L, O = m.decodeEntities, M = O === void 0 ? !0 : O;
      ...
      return b.prototype.reset = function() {
        ...
        var A = this.sequenceIndex === this.currentSequence.length, L = A ? (
        ...
        if (this.sequenceIndex === this.currentSequence.length) {
          if (m === t.Gt || a(m)) {
            var A = this.index - this.currentSequence.length;
            if (this.sectionStart < A) {
              var L = this.index;
              this.index = A, this.cbs.ontext(this.sectionStart, A), this.index = L;
            }
            this.isSpecial = !1, this.sectionStart = A + 2, this.stateInClosingTagName(m);
            return;
          }
      ...
      }, b.prototype.startSpecial = function(m, A) {
        this.isSpecial = !0, this.currentSequence = m, this.sequenceIndex = A, this.state = r.SpecialStartSequence;
        ...
        if (m === t.ExclamationMark)
          ...
          var A = m | 32;
          this.sectionStart = this.index, !this.xmlMode && A === s.TitleEnd[2] ? this.startSpecial(s.TitleEnd, 3) : this.state = !this.xmlMode && A === s.ScriptEnd[2] ? r.BeforeSpecialS : r.InTagName;
        } else
      ...
      }, b.prototype.handleInAttributeValue = function(m, A) {
        m === A || !this.decodeEntities && this.fastForwardTo(A) ? (this.cbs.onattribdata(this.sectionStart, this.index), this.sectionStart = -1, this.cbs.onattribend(A === t.DoubleQuote ? d.Double : d.Single, this.index), this.state = r.BeforeAttributeName) : this.decodeEntities && m === t.Amp && (this.baseState = this.state, this.state = r.BeforeEntity);
        ...
        var A = m | 32;
        A === s.ScriptEnd[3] ? this.startSpecial(s.ScriptEnd, 4) : A === s.StyleEnd[3] ? this.startSpecial(s.StyleEnd, 4) : (this.state = r.InTagName, this.stateInTagName(m));
        ...
        var A = this.trieCurrent & u.BinTrieFlags.VALUE_LENGTH;
        if (A) {
          var L = (A >> 14) - 1;
          if (!this.allowLegacyEntity() && m !== t.Semi)
            ...
            I > this.sectionStart && this.emitPartial(this.sectionStart, I), this.entityResult = this.trieIndex, this.trieIndex += L, this.entityExcess = 0, this.sectionStart = this.index + 1, L === 0 && this.emitNamedEntity();
          }
        }
        ...
        var A = this.index - this.entityExcess - 1, L = A + 2 + +(this.state === r.InHexEntity);
        L !== this.index && (A > this.sectionStart && this.emitPartial(this.sectionStart, A), this.sectionStart = this.index + Number(m), this.emitCodePoint((0, u.replaceCodePoint)(this.entityResult))), this.state = this.baseState;
      ...
      }, b.prototype.emitPartial = function(m, A) {
        this.baseState !== r.Text && this.baseState !== r.InSpecialTag ? this.cbs.onattribdata(m, A) : this.cbs.ontext(m, A);
...
var K4 = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), J4 = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), Z4 = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && K4(u, e, t);
  return J4(u, e), u;
};
Object.defineProperty($0, "__esModule", { value: !0 });
$0.Parser = void 0;
var Ar = Z4(tc), Xc = V0, jt = /* @__PURE__ */ new Set([
  "input",
  "option",
  "optgroup",
  "select",
  ...
  "datalist",
  "textarea"
]), me = /* @__PURE__ */ new Set(["p"]), Wc = /* @__PURE__ */ new Set(["thead", "tbody"]), zc = /* @__PURE__ */ new Set(["dd", "dt"]), Qc = /* @__PURE__ */ new Set(["rt", "rp"]), em = /* @__PURE__ */ new Map([
  ...
  function() {
    ...
    return e.prototype.ontext = function(u, t) {
      ...
      return !this.options.xmlMode && um.has(u);
      ...
      var i = !this.options.xmlMode && em.get(u);
      if (i)
      ...
      var t = u.search(tm), r = t < 0 ? u : u.substr(0, t);
      ...
      this.endIndex = t;
      var A = this.getSlice(u, t - r);
      this.options.xmlMode || this.options.recognizeCDATA ? ((n = (a = this.cbs).oncdatastart) === null || n === void 0 || n.call(a), (c = (i = this.cbs).ontext) === null || c === void 0 || c.call(i, A), (d = (o = this.cbs).oncdataend) === null || d === void 0 || d.call(o)) : ((E = (s = this.cbs).oncomment) === null || E === void 0 || E.call(s, "[CDATA[".concat(A, "]]")), (m = (b = this.cbs).oncommentend) === null || m === void 0 || m.call(b)), this.startIndex = t + 1;
...
$0.Parser = rm;
var Zu = {}, fe = {}, pt = C && C.__extends || function() {
  var e = function(u, t) {
    return e = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, a) {
      r.__proto__ = a;
    } || function(r, a) {
...
function ic(e, u) {
  ...
  if (z1(e))
    ...
    var r = u ? pn(e.children) : [], a = new Y1(e.name, H0({}, e.attribs), r);
    r.forEach(function(o) {
      return o.parent = a;
    ...
    var r = u ? pn(e.children) : [], n = new $1(r);
    r.forEach(function(d) {
      return d.parent = n;
    }), t = n;
  } else if (J1(e)) {
    var r = u ? pn(e.children) : [], i = new V1(r);
    r.forEach(function(d) {
      return d.parent = i;
    }), e["x-mode"] && (i["x-mode"] = e["x-mode"]), t = i;
  } else if (K1(e)) {
    var c = new j1(e.name, e.data);
    e["x-name"] != null && (c["x-name"] = e["x-name"], c["x-publicId"] = e["x-publicId"], c["x-systemId"] = e["x-systemId"]), t = c;
  } else
    throw new Error("Not implemented yet: ".concat(e.type));
  return t.startIndex = e.startIndex, t.endIndex = e.endIndex, e.sourceCodeLocation != null && (t.sourceCodeLocation = e.sourceCodeLocation), t;
...
var nm = C && C.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(Pt, "__esModule", { value: !0 });
Pt.encodeNonAsciiHTML = Pt.encodeHTML = void 0;
var im = nm(cc), el = ta, cm = /[\t\n!-,./:-@[-`\f{-}$\x80-\uFFFF]/g;
function sm(e) {
  return ul(cm, e);
}
Pt.encodeHTML = sm;
function om(e) {
  return ul(el.xmlReplacer, e);
}
Pt.encodeNonAsciiHTML = om;
function ul(e, u) {
  for (var t = "", r = 0, a; (a = e.exec(u)) !== null; ) {
    var n = a.index;
    t += u.substring(r, n);
    var i = u.charCodeAt(n), c = im.default.get(i);
    if (typeof c == "object") {
      if (n + 1 < u.length) {
        var o = u.charCodeAt(n + 1), d = typeof c.n == "number" ? c.n === o ? c.o : void 0 : c.n.get(o);
        if (d !== void 0) {
...
var zt = C && C.__assign || function() {
...
}, dm = C && C.__createBinding || (Object.create ? function(e, u, t, r) {
  r === void 0 && (r = t);
  var a = Object.getOwnPropertyDescriptor(u, t);
  (!a || ("get" in a ? !u.__esModule : a.writable || a.configurable)) && (a = { enumerable: !0, get: function() {
    return u[t];
  ...
  r === void 0 && (r = t), e[r] = u[t];
}), lm = C && C.__setModuleDefault || (Object.create ? function(e, u) {
  Object.defineProperty(e, "default", { enumerable: !0, value: u });
} : function(e, u) {
  e.default = u;
}), fm = C && C.__importStar || function(e) {
  if (e && e.__esModule)
    return e;
  var u = {};
  if (e != null)
    for (var t in e)
      t !== "default" && Object.prototype.hasOwnProperty.call(e, t) && dm(u, e, t);
  return lm(u, e), u;
};
Object.defineProperty(or, "__esModule", { value: !0 });
or.render = void 0;
var Qu = fm(Pe), ra = Z1, tl = b0, bm = /* @__PURE__ */ new Set([
  "style",
  "script",
  "xmp",
  "iframe",
...
function pm(e, u) {
  var t;
  if (e) {
    var r = ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) === !1 ? hm : u.xmlMode || u.encodeEntities !== "utf8" ? ra.encodeXML : ra.escapeAttribute;
    return Object.keys(e).map(function(a) {
      var n, i, c = (n = e[a]) !== null && n !== void 0 ? n : "";
      return u.xmlMode === "foreign" && (a = (i = tl.attributeNames.get(a)) !== null && i !== void 0 ? i : a), !u.emptyAttrs && !u.xmlMode && c === "" ? a : "".concat(a, '="').concat(r(c), '"');
    }).join(" ");
  }
}
...
var gm = /* @__PURE__ */ new Set([
  ...
  "desc",
  "title"
]), Em = /* @__PURE__ */ new Set(["svg", "math"]);
function Tm(e, u) {
  var t;
  u.xmlMode === "foreign" && (e.name = (t = tl.elementNames.get(e.name)) !== null && t !== void 0 ? t : e.name, e.parent && gm.has(e.parent.name) && (u = zt(zt({}, u), { xmlMode: !1 }))), !u.xmlMode && Em.has(e.name) && (u = zt(zt({}, u), { xmlMode: "foreign" }));
  var r = "<".concat(e.name), a = pm(e.attribs, u);
  return a && (r += " ".concat(a)), e.children.length === 0 && (u.xmlMode ? (
    // In XML mode or foreign mode, and user hasn't explicitly turned off self-closing tags
    u.selfClosingTags !== !1
  ) : (
...
function ym(e, u) {
  var t, r = e.data || "";
  return ((t = u.encodeEntities) !== null && t !== void 0 ? t : u.decodeEntities) !== !1 && !(!u.xmlMode && e.parent && bm.has(e.parent.name)) && (r = u.xmlMode || u.encodeEntities !== "utf8" ? (0, ra.encodeXML)(r) : (0, ra.escapeText)(r)), r;
}
function Am(e) {
  return "<![CDATA[".concat(e.children[0].data, "]]>");
}
...
var xm = C && C.__importDefault || function(e) {
  return e && e.__esModule ? e : { default: e };
};
Object.defineProperty(vu, "__esModule", { value: !0 });
vu.innerText = vu.textContent = vu.getText = vu.getInnerHTML = vu.getOuterHTML = void 0;
var ju = Zu, Nm = xm(or), Im = Pe;
function rl(e, u) {
  return (0, Nm.default)(e, u);
}
vu.getOuterHTML = rl;
function Dm(e, u) {
  return (0, ju.hasChildren)(e) ? e.children.map(function(t) {
    return rl(t, u);
  }).join("") : "";
}
vu.getInnerHTML = Dm;
function Rr(e) {
  return Array.isArray(e) ? e.map(Rr).join("") : (0, ju.isTag)(e) ? e.name === "br" ? `
` : Rr(e.children) : (0, ju.isCDATA)(e) ? Rr(e.children) : (0, ju.isText)(e) ? e.data : "";
}
vu.getText = Rr;
function ti(e) {
  return Array.isArray(e) ? e.map(ti).join("") : (0, ju.hasChildren)(e) && !(0, ju.isComment)(e) ? ti(e.children) : (0, ju.isText)(e) ? e.data : "";
}
vu.textContent = ti;
function ri(e) {
  return Array.isArray(e) ? e.map(ri).join("") : (0, ju.hasChildren)(e) && (e.type === Im.ElementType.Tag || (0, ju.isCDATA)(e)) ? ri(e.children) : (0, ju.isText)(e) ? e.data : "";
}
vu.innerText = ri;
var Ge = {};
...
Ge.nextElementSibling = Pm;
function wm(e) {
  for (var u, t = e.prev; t !== null && !(0, sc.isTag)(t); )
    u = t, t = u.prev;
  return t;
}
Ge.prevElementSibling = wm;
var su = {};
...
var Xa = Zu;
function Hm(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), il(e, Array.isArray(u) ? u : [u], t, r);
}
Je.filter = Hm;
function il(e, u, t, r) {
  for (var a = [], n = [u], i = [0]; ; ) {
...
function cl(e, u, t) {
  ...
  for (var r = null, a = 0; a < u.length && !r; a++) {
    var n = u[a];
    if ((0, Xa.isTag)(n))
      e(n) ? r = n : t && n.children.length > 0 && (r = cl(e, n.children, !0));
    else
      continue;
  }
  return r;
...
function sl(e, u) {
  return u.some(function(t) {
    return (0, Xa.isTag)(t) && (e(t) || sl(e, t.children));
  });
}
Je.existsOne = sl;
function qm(e, u) {
...
function dl(e) {
  var u = Object.keys(e).map(function(t) {
    var r = e[t];
    return Object.prototype.hasOwnProperty.call(aa, t) ? aa[t](r) : ol(t, r);
  });
  return u.length === 0 ? null : u.reduce(Gm);
}
function jm(e, u) {
  var t = dl(e);
  return t ? t(u) : !0;
...
xu.getElements = $m;
function Vm(e, u, t) {
  return t === void 0 && (t = !0), Array.isArray(u) || (u = [u]), (0, Wa.findOne)(ol("id", e), u, t);
}
xu.getElementById = Vm;
function Ym(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, Wa.filter)(aa.tag_name(e), u, t, r);
}
xu.getElementsByTagName = Ym;
function Xm(e, u, t, r) {
  return t === void 0 && (t = !0), r === void 0 && (r = 1 / 0), (0, Wa.filter)(aa.tag_type(e), u, t, r);
}
xu.getElementsByTagType = Xm;
var ll = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.uniqueSort = e.compareDocumentPosition = e.DocumentPosition = e.removeSubsets = void 0;
  var u = Zu;
...
function zm(e) {
  var u = na(e8, e);
  return u ? u.name === "feed" ? Qm(u) : Km(u) : null;
}
za.getFeed = zm;
function Qm(e) {
  var u, t = e.children, r = {
    ...
    items: (0, lr.getElementsByTagName)("entry", t).map(function(i) {
      var c, o = i.children, d = { media: fl(o) };
...
function fl(e) {
  return (0, lr.getElementsByTagName)("media:content", e).map(function(u) {
    for (var t = u.attribs, r = {
      medium: t.medium,
      isDefault: !!t.isDefault
    }, a = 0, n = Jm; a < n.length; a++) {
      var i = n[a];
      t[i] && (r[i] = t[i]);
    }
    for (var c = 0, o = Zm; c < o.length; c++) {
      var i = o[c];
      t[i] && (r[i] = parseInt(t[i], 10));
    }
    return t.expression && (r.expression = t.expression), r;
...
function st(e, u, t) {
  return t === void 0 && (t = !1), (0, Wm.textContent)((0, lr.getElementsByTagName)(e, u, t, 1)).trim();
}
...
(function(e) {
  ...
  Object.defineProperty(e, "__esModule", { value: !0 }), e.hasChildren = e.isDocument = e.isComment = e.isText = e.isCDATA = e.isTag = void 0, t(vu, e), t(Ge, e), t(su, e), t(Je, e), t(xu, e), t(ll, e), t(za, e);
  var r = Zu;
  Object.defineProperty(e, "isTag", { enumerable: !0, get: function() {
    return r.isTag;
  } }), Object.defineProperty(e, "isCDATA", { enumerable: !0, get: function() {
...
(function(e) {
  ...
  var L = { xmlMode: !0 };
  function I(O, M) {
    return M === void 0 && (M = L), (0, m.getFeed)(s(O, M));
  }
  e.parseFeed = I, e.DomUtils = r(wr);
})(F1);
(function(e) {
  var u = C && C.__createBinding || (Object.create ? function(A, L, I, O) {
    O === void 0 && (O = I);
    var M = Object.getOwnPropertyDescriptor(L, I);
    (!M || ("get" in M ? !L.__esModule : M.writable || M.configurable)) && (M = { enumerable: !0, get: function() {
      return L[I];
    } }), Object.defineProperty(A, O, M);
  } : function(A, L, I, O) {
    O === void 0 && (O = I), A[O] = L[I];
  }), t = C && C.__setModuleDefault || (Object.create ? function(A, L) {
    Object.defineProperty(A, "default", { enumerable: !0, value: L });
  } : function(A, L) {
    A.default = L;
  }), r = C && C.__exportStar || function(A, L) {
    for (var I in A)
      I !== "default" && !Object.prototype.hasOwnProperty.call(L, I) && u(L, A, I);
  }, a = C && C.__importStar || function(A) {
    if (A && A.__esModule)
      return A;
    var L = {};
    if (A != null)
      for (var I in A)
        I !== "default" && Object.prototype.hasOwnProperty.call(A, I) && u(L, A, I);
    return t(L, A), L;
  }, n = C && C.__importDefault || function(A) {
    return A && A.__esModule ? A : { default: A };
  };
  Object.defineProperty(e, "__esModule", { value: !0 }), e.root = e.parseHTML = e.merge = e.contains = e.text = e.xml = e.html = e.load = void 0, r(Ys, e);
  var i = ca, c = Ot, o = o0, d = n(m0), s = F1, E = (0, c.getParse)(function(A, L, I, O) {
    return L.xmlMode || L._useHtmlParser2 ? (0, s.parseDocument)(A, L) : (0, o.parseWithParse5)(A, L, I, O);
  });
  e.load = (0, i.getLoad)(E, function(A, L) {
    return L.xmlMode || L._useHtmlParser2 ? (0, d.default)(A, L) : (0, o.renderWithParse5)(A);
  }), e.default = (0, e.load)([]);
  var b = Ce;
...
(function(e, u) {
  ...
  function r(a) {
    ...
    n.unshift("[" + a + "]"), Ou.process.stderr.write(n.join(" ") + `
`);
  }
})(hl);
var oc = hl.exports;
(function(e, u) {
  oc("lex"), e.exports = t;
  function t(r) {
    var a = "", n, i = 0, c = -1, o = 0, d = 1, s = "before-selector", E = [s], b = {}, m = [], A = [
      "media",
      "keyframes",
        ...
        case "@":
          switch (I()) {
            ...
            case "before-value":
              ...
              break;
            default:
              for (var g = !1, T, v, D = 0, k = A.length; !g && D < k; ++D)
                v = A[D], T = v.name || v, O(T) && (g = !0, V(T), F(v.state || "at-group"), Z(T.length), v.prefix && (b.prefix = v.prefix), v.type && (b.type = v.type));
              g || (a += n);
              break;
          }
          break;
...
`, c = " ");
    var F = A(B.stylesheet.rules, M).join(`
`).trim();
    return F;
  }
  function d(B) {
  ...
  function m(B) {
    var w;
    return B.selectors ? w = B.selectors.join("," + i) : (w = "@" + B.type, w += B.name ? " " + B.name : ""), d() + w + c + L(B) + i;
  }
  function A(B, w) {
...
var t8 = gl.exports, r8 = {
  lex: pl,
  parse: u8,
  stringify: t8
}, El = { exports: {} }, a8 = /([-.*+?^${}()|[\]\/\\])/g, n8 = /\\/g, yt = function(e) {
  return (e + "").replace(a8, "\\$1");
}, _t = function(e) {
  return (e + "").replace(n8, "");
}, i8 = RegExp(
  /*
...
var c8 = function(e, u, t, r, a, n, i, c, o, d, s, E, b, m, A, L) {
  var I, O;
  if ((u || !this.length) && (I = this[this.length++] = new _l(), u))
    return "";
  if (I || (I = this[this.length - 1]), (t || r || !I.length) && (O = I[I.length++] = new Tl(t)), O || (O = I[I.length - 1]), a)
    O.tag = _t(a);
  else if (n)
    O.id = _t(n);
  else if (i) {
    ...
    b ? (L = L || A, (O.pseudos || (O.pseudos = [])).push({
      type: E.length == 1 ? "class" : "element",
      name: _t(b),
      escapedName: yt(b),
      value: L ? _t(L) : null,
      escapedValue: L ? yt(L) : null
  ...
  for (var t = this, r = u, a; u; ) {
    if (a = u.replace(i8, function() {
      return c8.apply(t, arguments);
    }), a === u)
...
var es = {}, s8 = function(e) {
  return e == null ? null : (e = ("" + e).replace(/^\s+|\s+$/g, ""), es[e] || (es[e] = new yl(e)));
}, o8 = s8;
(function(e, u) {
  var t = o8;
  e.exports = r;
  ...
  r.prototype.parsed = function() {
    ...
    function i(c, o) {
      for (var d = o || a(c), s = [n ? 1 : 0, 0, 0, 0], E = [], b = 0; b < d.length; b++) {
        var m = d[b], A = m.pseudos;
        if (m.id && s[1]++, m.attributes && (s[2] += m.attributes.length), m.classList && (s[2] += m.classList.length), m.tag && m.tag !== "*" && s[3]++, A) {
          s[3] += A.length;
          for (var L = 0; L < A.length; L++)
            A[L].name === "not" && (E.push(A[L].value), s[3]--);
        }
      }
...
var d8 = El.exports, gn = { exports: {} }, us;
function l8() {
...
var tt = dc(), xr = lc, b8 = function(u) {
  ...
  function t(m, A, L) {
    L = L || {};
    var I = tt.parseCSS(A), O = [], M = "style", U = {};
    if (L.styleAttributeName && (M = L.styleAttributeName), I.forEach(F), O.forEach(z), L.inlinePseudoElements && O.forEach(Z), L.applyWidthAttributes && O.forEach(function(g) {
      ue(g, "width");
    }), L.applyHeightAttributes && O.forEach(function(g) {
      ue(g, "height");
    }), L.applyAttributesTableElements && O.forEach(l), L.insertPreservedExtraCss && L.extraCss) {
      var B = tt.getPreservedText(L.extraCss, {
        mediaQueries: L.preserveMediaQueries,
        fontFaces: L.preserveFontFaces,
        keyFrames: L.preserveKeyFrames
      });
      if (B) {
        var w = null;
        L.insertPreservedExtraCss !== !0 ? w = m(L.insertPreservedExtraCss) : (w = m("head"), w.length || (w = m("body")), w.length || (w = m.root())), w.first().append("<style>" + B + "</style>");
      }
    }
    function F(g) {
      var T = g[0], v = g[1], D = new tt.Selector(T), k = D.parsed();
      if (k) {
        ...
        Iu.each(function() {
          ...
          if (!he.styleProps) {
            if (he.styleProps = {}, m(he).attr(M)) {
              var ye = "* { " + m(he).attr(M) + " } ";
              gt(tt.parseCSS(ye)[0][1], new tt.Selector("<style>", !0));
            }
            O.push(he);
          }
          function mt(Be, Ve) {
          ...
          function gt(Be, Ve) {
            for (var _e = 0, je = Be.length; _e < je; _e++)
              if (Be[_e].type == "property") {
                ...
                Et && !L.preserveImportant && (Ne = r(Ne));
                var ut = [Be[_e].position.start.line, Be[_e].position.start.col], Y = new tt.Property(Se, Ne, Ve, Et ? 2 : 0, ut), Q = he.styleProps[Se];
    ...
    function Z(g) {
      if (g.pseudoElementType && g.styleProps.content) {
        ...
        var v = g.pseudoElementParent;
        g.pseudoElementType === "before" ? m(v).prepend(g) : m(v).append(g);
      }
    }
    function ue(g, T) {
      if (g.name) {
        var v = g.name.toUpperCase();
        if (u[T + "Elements"].indexOf(v) > -1) {
          for (var D in g.styleProps)
            if (g.styleProps[D].prop === T) {
              var k = g.styleProps[D].value;
              if (L.preserveImportant && (k = r(k)), k.match(/(px|auto)/)) {
                var R = k.replace("px", "");
                m(g).attr(T, R);
                return;
              }
              if (u.tableElements.indexOf(v) > -1 && k.match(/\%/)) {
                m(g).attr(T, k);
                return;
              }
            }
    ...
    function l(g) {
      if (g.name) {
        var T = g.name.toUpperCase(), v = Object.keys(u.styleToAttribute);
        if (u.tableElements.indexOf(T) > -1) {
          for (var D in g.styleProps)
            if (v.indexOf(g.styleProps[D].prop) > -1) {
              var k = u.styleToAttribute[g.styleProps[D].prop], R = g.styleProps[D].value;
              if (L.preserveImportant && (R = r(R)), k === "background" && (R = V(R)), /(linear|radial)-gradient\(/i.test(R))
                continue;
              m(g).attr(k, R);
            }
        }
  ...
  function a(m, A) {
    for (; m; ) {
      if (A in m.styleProps)
        return m.styleProps[A].value;
  ...
  function i(m) {
    var A = m.styleProps.content.value;
    if (A === "none" || A === "normal")
      return "";
    var L = A.match(/^\s*url\s*\(\s*(.*?)\s*\)\s*$/i);
    if (L) {
      var I = L[1].replace(/^['"]|['"]$/g, "");
      return { img: I };
    }
    for (var O = [], M = A.split(/['"]/), U = 0; U < M.length; U++)
      if (M[U] !== "") {
    ...
    return A = O.join(""), A = A.replace(/\\/g, ""), A;
  }
  function c(m) {
    if (m.length !== 0) {
      var A = m[m.length - 1].pseudos;
      if (A) {
        for (var L = 0; L < A.length; L++)
          if (o(A[L]))
            return A[L].name;
  ...
  function s(m, A) {
    A = tt.getDefaultOptions(A);
    var L = b(m, A);
    return L += `
` + A.extraCss, t(m, L, A), m;
  }
  function E(m, A) {
    var L = [], I = m("style"), O, M, U;
    return I.each(function() {
      U = this;
      var B = !!U.childNodes;
      if (O = B ? U.childNodes : U.children, O.length !== 1) {
        A.removeStyleTags && m(U).remove();
        return;
      }
      if (M = O[0].data, A.applyStyleTags && m(U).attr("data-embed") === void 0 && L.push(M), A.removeStyleTags && m(U).attr("data-embed") === void 0) {
        var w = B ? U.childNodes[0].nodeValue : U.children[0].data, F = tt.getPreservedText(w, {
          mediaQueries: A.preserveMediaQueries,
          fontFaces: A.preserveFontFaces,
          keyFrames: A.preserveKeyFrames,
          pseudos: A.preservePseudos
        }, u.ignoredPseudos);
  ...
  function b(m, A) {
    var L = E(m, A), I = L.join(`
`);
    return I;
  }
  return u;
}, fc = f8, h8 = b8, Y0 = h8(function(e, u) {
  return fc(e, { xmlMode: u && u.xmlMode }, p8, [u]);
}), p8 = function(e, u) {
...
Lu.prototype.space = null;
Lu.prototype.boolean = !1;
Lu.prototype.booleanish = !1;
Lu.prototype.overloadedBoolean = !1;
Lu.prototype.number = !1;
Lu.prototype.commaSeparated = !1;
Lu.prototype.spaceSeparated = !1;
Lu.prototype.commaOrSpaceSeparated = !1;
Lu.prototype.mustUseProperty = !1;
Lu.prototype.defined = !1;
let g8 = 0;
const ae = Ht(), Oe = Ht(), vl = Ht(), X = Ht(), Te = Ht(), e0 = Ht(), pu = Ht();
function Ht() {
  return 2 ** ++g8;
}
...
const E8 = {}.hasOwnProperty;
function _0(e) {
  const u = {}, t = {};
  let r;
  for (r in e.properties)
    if (E8.call(e.properties, r)) {
...
}), y8 = /^data[-\w.:]+$/i, as = /-[a-z]/g, A8 = /[A-Z]/g;
function Qa(e, u) {
  const t = X0(u);
  let r = u, a = Lu;
  if (t in e.normal)
    return e.property[e.normal[t]];
  if (t.length > 4 && t.slice(0, 4) === "data" && y8.test(u)) {
    if (u.charAt(4) === "-") {
      const n = u.slice(5).replace(as, x8);
      r = "data" + n.charAt(0).toUpperCase() + n.slice(1);
    } else {
      const n = u.slice(4);
      if (!as.test(n)) {
        let i = n.replace(A8, v8);
...
const br = Al([Nl, xl, Cl, Sl, T8], "html"), Ft = Al([Nl, xl, Cl, Sl, _8], "svg");
function ii(e) {
  const u = [], t = String(e || "");
...
const I8 = /* @__PURE__ */ new Set(["button", "menu", "reset", "submit"]), si = {}.hasOwnProperty;
function Pl(e, u, t) {
  const r = t && O8(t);
  function a(n, i, ...c) {
    let o = -1, d;
    if (n == null) {
      ...
      c.unshift(s);
    } else if (d = N8(n, u), d.tagName = d.tagName.toLowerCase(), r && si.call(r, d.tagName) && (d.tagName = r[d.tagName]), D8(i, d.tagName)) {
      let s;
      for (s in i)
        si.call(i, s) && C8(e, d.properties, s, i[s]);
    } else
      c.unshift(i);
    for (; ++o < c.length; )
      oi(d.children, c[o]);
...
function D8(e, u) {
  return e == null || typeof e != "object" || Array.isArray(e) ? !1 : u === "input" || !e.type || typeof e.type != "string" ? !0 : "children" in e && Array.isArray(e.children) ? !1 : u === "button" ? I8.has(e.type.toLowerCase()) : !("value" in e);
}
function C8(e, u, t, r) {
  const a = Qa(e, t);
  let n = -1, i;
  if (r != null) {
    if (typeof r == "number") {
      ...
      typeof r == "boolean" ? i = r : typeof r == "string" ? a.spaceSeparated ? i = ci(r) : a.commaSeparated ? i = ii(r) : a.commaOrSpaceSeparated ? i = ci(ii(r).join(" ")) : i = is(a, a.property, r) : Array.isArray(r) ? i = r.concat() : i = a.property === "style" ? S8(r) : String(r);
    if (Array.isArray(i)) {
      const c = [];
      for (; ++n < i.length; ) {
        const o = (
...
const L8 = [
  ...
  "textArea",
  "textPath"
], P8 = Pl(br, "div"), w8 = Pl(Ft, "g", L8), Tn = /\r?\n|\r/g;
function R8(e) {
  const u = String(e), t = [];
...
}, wl = {}.hasOwnProperty, k8 = Object.prototype;
function B8(e, u) {
  const t = u || {};
  return hc(
    {
...
function hc(e, u) {
  ...
  switch (u.nodeName) {
    ...
    case "#document-fragment": {
      ...
      if (t = {
        type: "root",
        children: Rl(e, u.childNodes),
        data: { quirksMode: a }
      }, e.file && e.location) {
        const n = String(e.file), i = R8(n), c = i.toPoint(0), o = i.toPoint(n.length);
...
function U8(e, u) {
  const t = e.schema;
  e.schema = u.namespaceURI === M8.svg ? Ft : br;
  let r = -1;
  const a = {};
  for (; ++r < u.attrs.length; ) {
    const c = u.attrs[r], o = (c.prefix ? c.prefix + ":" : "") + c.name;
    wl.call(k8, o) || (a[o] = c.value);
  }
  const i = (e.schema.space === "svg" ? w8 : P8)(u.tagName, a, Rl(e, u.childNodes));
...
function Mr(e, u, t) {
  if ("sourceCodeLocation" in u && u.sourceCodeLocation && e.file) {
    const r = H8(e, t, u.sourceCodeLocation);
...
function H8(e, u, t) {
  ...
  if (u.type === "element") {
    ...
    if (r && !t.endTag && a && a.position && a.position.end && (r.end = Object.assign({}, a.position.end)), e.verbose) {
      ...
      if (t.attrs)
        for (i in t.attrs)
          wl.call(t.attrs, i) && (n[Qa(e.schema, i).property] = Qt(
            t.attrs[i]
          ));
      t.startTag;
...
const Bu = { basename: q8, dirname: G8, extname: j8, join: $8, sep: "/" };
function q8(e, u) {
...
class fi {
  ...
  constructor(u) {
    let t;
    u ? li(u) ? t = { path: u } : typeof u == "string" || K8(u) ? t = { value: u } : t = u : t = {}, this.cwd = X8.cwd(), this.data = {}, this.history = [], this.messages = [], this.value, this.map, this.result, this.stored;
    let r = -1;
    for (; ++r < _n.length; ) {
      const n = _n[r];
   ...
   */
  set basename(u) {
    An(u, "basename"), yn(u, "basename"), this.path = Bu.join(this.dirname || "", u);
  }
  /**
   ...
   */
  set dirname(u) {
    ds(this.basename, "dirname"), this.path = Bu.join(u || "", this.basename);
  }
  /**
  ...
  set extname(u) {
    ...
    this.path = Bu.join(this.dirname, this.stem + (u || ""));
  }
  /**
   ...
   */
  set path(u) {
    li(u) && (u = z8(u)), An(u, "path"), this.path !== u && this.history.push(u);
  }
  /**
   ...
   */
  set stem(u) {
    An(u, "stem"), yn(u, "stem"), this.path = Bu.join(this.dirname || "", u + (this.extname || ""));
  }
...
function yn(e, u) {
  if (e && e.includes(Bu.sep))
    throw new Error(
      "`" + u + "` cannot be a path: did not expect `" + Bu.sep + "`"
    );
}
function An(e, u) {
  if (!e)
...
}, Z8 = "https://html.spec.whatwg.org/multipage/parsing.html#parse-error-", eg = /-[a-z]/g, ug = /%c(?:([-+])(\d+))?/g, tg = /%x/g, rg = { 2: !0, 1: !1, 0: null }, ag = {};
function ng(e, u) {
  const t = u || ag, r = t.onerror, a = e instanceof fi ? e : new fi(e), n = t.fragment ? q0.parseFragment : q0.parse, i = String(a), c = n(i, {
  ...
  function o(d) {
    const s = d.code, E = ig(s), b = t[E], m = b ?? !0, A = typeof m == "number" ? m : m ? 1 : 0;
    if (A) {
      const I = J8[E], O = new Ze(L(I.reason), {
        place: {
          start: {
            line: d.startLine,
            column: d.startCol,
      ...
      a.path && (O.file = a.path, O.name = a.path + ":" + O.name), O.fatal = rg[A], O.note = L(I.description), O.url = I.url === !1 ? void 0 : Z8 + s, r(O);
    }
    function L(I) {
      return I.replace(ug, O).replace(tg, M);
      function O(U, B, w) {
        const F = (w ? Number.parseInt(w, 10) : 0) * (B === "-" ? -1 : 1), z = i.charAt(d.startOffset + F);
        return sg(z);
      }
      function M() {
        return og(i.charCodeAt(d.startOffset));
      }
    }
  }
}
...
const mg = [
  ...
  "para",
  "times"
], kl = {}.hasOwnProperty, bi = {};
let Nr;
for (Nr in vn)
  kl.call(vn, Nr) && (bi[vn[Nr]] = Nr);
function Eg(e, u, t, r) {
  const a = String.fromCharCode(e);
  if (kl.call(bi, a)) {
    const n = bi[a], i = "&" + n;
    return t && mg.includes(n) && !gg.includes(n) && (!r || u && u !== 61 && /[^\da-z]/i.test(String.fromCharCode(u))) ? i : i + ";";
  }
  return "";
}
function Tg(e, u, t) {
  let r = hg(e, u, t.omitOptionalSemicolons), a;
  if ((t.useNamedReferences || t.useShortestReferences) && (a = Eg(
    e,
    u,
    t.omitOptionalSemicolons,
    t.attribute
  )), (t.useShortestReferences || !a) && t.useShortestReferences) {
    const n = pg(e, u, t.omitOptionalSemicolons);
    n.length < r.length && (r = n);
  }
  return a && (!t.useShortestReferences || a.length < r.length) ? a : r;
}
function u0(e, u) {
  return fg(e, Object.assign({ format: Tg }, u));
}
function _g(e, u, t, r) {
...
const ke = Ul(1), Bl = Ul(-1), vg = [];
function Ul(e) {
  return u;
  function u(t, r, a) {
    const n = t ? t.children : vg;
    let i = (r || 0) + e, c = n[i];
    if (!a)
      for (; c && Ka(c); )
        i += e, c = n[i];
...
const xg = {}.hasOwnProperty;
function Hl(e) {
  return u;
  function u(t, r, a) {
    return xg.call(e, t.tagName) && e[t.tagName](t, r, a);
  }
}
const pc = Hl({
  body: Ig,
...
function jg(e, u, t, r) {
  ...
  const d = $g(r, e.properties), s = r.all(
    a.space === "html" && e.tagName === "template" ? e.content : e
  );
  return r.schema = a, s && (i = !1), (d || !n || !Bg(e, u, t)) && (c.push("<", e.tagName, d ? " " + d : ""), i && (a.space === "svg" || r.settings.closeSelfClosing) && (o = d.charAt(d.length - 1), (!r.settings.tightSelfClosing || o === "/" || o && o !== '"' && o !== "'") && c.push(" "), c.push("/")), c.push(">")), c.push(s), !i && (!n || !pc(e, u, t)) && c.push("</" + e.tagName + ">"), c.join("");
}
function $g(e, u) {
  const t = [];
  let r = -1, a;
...
function Vg(e, u, t) {
  ...
  return t === !0 || (t = Array.isArray(t) ? (r.commaSeparated ? Ol : Ll)(t, {
...
function Yg(e, u, t, r) {
  return r.settings.allowDangerousHtml ? e.value : Fl(e, u, t, r);
}
function Xg(e, u, t, r) {
  return r.all(e);
}
const Wg = Ml("type", {
  invalid: zg,
  unknown: Qg,
  handlers: { comment: _g, doctype: yg, element: jg, raw: Yg, root: Xg, text: Fl }
});
function zg(e) {
...
function eE(e, u) {
  ...
  return {
    ...
    settings: {
      ...
      voids: t.voids || lg,
      characterReferences: t.characterReferences || Jg,
...
function uE(e, u, t) {
  return Wg(e, u, t, this);
}
function tE(e) {
  const u = [], t = e && e.children || Zg;
  let r = -1;
  for (; ++r < t.length; )
...
var kr = Object.prototype.hasOwnProperty, Gl = Object.prototype.toString, gs = Object.defineProperty, Es = Object.getOwnPropertyDescriptor, Ts = function(u) {
  return typeof Array.isArray == "function" ? Array.isArray(u) : Gl.call(u) === "[object Array]";
}, _s = function(u) {
  if (!u || Gl.call(u) !== "[object Object]")
    return !1;
...
class mc extends iE {
   ...
   */
  constructor() {
    super("copy"), this.Compiler = void 0, this.Parser = void 0, this.attachers = [], this.compiler = void 0, this.freezeIndex = -1, this.frozen = void 0, this.namespace = {}, this.parser = void 0, this.transformers = aE();
  }
  /**
   * Copy a processor.
   *
   ...
   */
  data(u, t) {
    return typeof u == "string" ? arguments.length === 2 ? (Cn("data", this.frozen), this.namespace[u] = t, this) : cE.call(this.namespace, u) && this.namespace[u] || void 0 : u ? (Cn("data", this.frozen), this.namespace = u, this) : this.namespace;
  }
  /**
   * Freeze a processor.
   *
  ...
  use(u, ...t) {
    ...
    function o(d, s) {
      ...
      if (b === -1)
        ...
        let [m, ...A] = s;
        const L = r[b][1];
        hi(L) && hi(m) && (m = Nn(!0, L, m)), r[b] = [d, m, ...A];
      }
    }
  }
}
const sE = new mc().freeze();
function In(e, u) {
  if (typeof u != "function")
...
const fE = sE().use(dg).use(ql).freeze(), jl = (
  ...
  function(e) {
    ...
    if (typeof e == "function")
      return Ja(e);
    if (typeof e == "object")
      return Array.isArray(e) ? bE(e) : hE(e);
    if (typeof e == "string")
      return pE(e);
...
function TE(e, u, t, r) {
  ...
  function c(o, d, s) {
    ...
    function b() {
      let m = $l, A, L, I;
      if ((!u || n(o, d, s[s.length - 1] || void 0)) && (m = _E(t(o, s)), m[0] === pi))
        return m;
      if ("children" in o && o.children) {
        ...
        if (O.children && m[0] !== Vl)
          for (L = (r ? O.children.length : -1) + i, I = s.concat(O); L > -1 && L < O.children.length; ) {
            const M = O.children[L];
            if (A = c(M, L, I)(), A[0] === pi)
              return A;
            L = typeof A[1] == "number" ? A[1] : L + i;
          }
      }
      return m;
    }
...
function _E(e) {
  return Array.isArray(e) ? e : typeof e == "number" ? [EE, e] : e == null ? $l : [e];
}
function mi(e, u, t, r) {
  let a, n, i;
  typeof u == "function" && typeof t != "function" ? (n = void 0, i = u, a = t) : (n = u, i = t, a = r), TE(e, n, c, a);
  function c(o, d) {
...
const IE = {}, DE = { wildcard: !0 };
function C0(e) {
  return e ? typeof e == "boolean" ? DE : e : IE;
}
function pr(e, u) {
  const t = { ...e };
  if ("tag" in u)
...
function PE(e = {}) {
  ...
  const E = !!t, b = a.combinators ? Ns(a.combinators) : Br, [m, A, L, I] = a.attributes ? [
    !0,
  ...
  ] : [!1, Br, D0, !1], O = I || Object.keys(L).length > 0, [M, U, B] = a.pseudoClasses ? [
    !0,
    a.pseudoClasses.definitions ? NE(a.pseudoClasses.definitions) : Ds,
  ...
  function hu() {
    ...
    for (; N0(T); )
      Y += $();
    return v(" ") && R(), String.fromCharCode(parseInt(Y, 16));
  }
  function Du(Y) {
    let Q = "";
    for (we(Y); g < l; ) {
  ...
  function Be() {
    ...
    if (v("|"))
      ...
      if (Y = {
        ...
        const ee = g;
        R(), Cr(T) || v("\\") ? (W(d, "Namespaces are not enabled."), Y = {
          type: "Attribute",
          name: ye(),
    ...
    if (v("]"))
      ...
      if (Y.operator = Iu(A), W(Y.operator, "Expected a valid attribute selector operator."), xe(), te(), LE[T] ? Y.value = {
        type: "String",
        value: Du(T)
      } : E && v("$") ? (R(), Y.value = {
        type: "Substitution",
        ...
        type: "String",
        value: ye()
      }, W(Y.value.value, "Expected attribute value.")), xe(), re() && !r || !v("]") && (Y.caseSensitivityModifier = ye(), W(Y.caseSensitivityModifier, "Expected end of attribute selector."), W(O, "Attribute case sensitivity modifiers are not enabled."), W(I || L[Y.caseSensitivityModifier], "Unknown attribute case sensitivity modifier."), xe(), re() && !r))
        return Y;
      we("]");
    }
    return Y;
  ...
  function je() {
    ...
    let Y = null, Q = 1;
    if (v("-") && (R(), Q = -1), _e() && (v("+") && R(), Y = Ve(), !v("\\") && !v("n")))
      return [0, Y * Q];
    Y === null && (Y = 1), Y *= Q;
    let ee;
    if (v("\\") ? (R(), N0(T) ? ee = hu() : ee = $()) : ee = $(), W(ee === "n", 'Formula parse error: expected "n".'), xe(), v("+") || v("-")) {
      const ce = v("+") ? 1 : -1;
      return R(), xe(), [Y, ce * Ve()];
    } else
      return [Y, 0];
  ...
  function Se(Y) {
    ...
    let ee = U[Y];
    if (!ee && B && (ee = AE), W(ee, `Unknown pseudo-class: "${Y}".`), ee = ee, v("(")) {
      if (R(), xe(), E && v("$"))
        R(), Q.argument = {
          type: "Substitution",
          name: ye()
  ...
  function Ne() {
    return v("*") ? (W(i, "Wildcard tag name is not enabled."), R(), { type: "WildcardTag" }) : Cr(T) || v("\\") ? (W(n, "Tag names are not enabled."), {
      type: "TagName",
      name: ye()
    }) : J("Expected tag name.");
  }
  ...
  function ut(Y = !1) {
    ...
    for (; g < l; ) {
      if (D())
        ...
        let ce = !1, Mu = !1;
        R(), v(":") && (W(w, "Pseudo elements are not enabled."), W(z, "Pseudo elements double colon notation is not enabled."), ce = !0, R());
        const Ue = ye();
        if (W(ce || Ue, "Expected pseudo-class name."), W(!ce || Ue, "Expected pseudo-element name."), W(!ce || ue || Z[Ue], `Unknown pseudo-element "${Ue}".`), Mu = w && (ce || !ce && F && Z[Ue]), Mu) {
          if (Q.pseudoElement = Ue, !Ss[T] && !v(",") && !v(")") && !re())
    ...
    if (Q.type = "Rule", xe(), !re() && !v(",") && !v(")")) {
      const ce = Iu(b);
      xe(), Q.nestedRule = ut(), Q.nestedRule.combinator = ce;
    }
    return Q;
  }
  return (Y) => {
...
const wE = PE({ syntax: "selectors-4" });
function RE(e) {
  if (typeof e != "string")
    throw new TypeError("Expected `string` as selector, not `" + e + "`");
  return wE(e);
}
const Wl = "֑-߿יִ-﷽ﹰ-ﻼ", zl = "A-Za-zÀ-ÖØ-öø-ʸ̀-֐ࠀ-῿‎Ⰰ-﬜︀-﹯﻽-￿", ME = new RegExp("^[^" + zl + "]*[" + Wl + "]"), kE = new RegExp("^[^" + Wl + "]*[" + zl + "]");
function BE(e) {
  const u = String(e || "");
  return ME.test(u) ? "rtl" : kE.test(u) ? "ltr" : "neutral";
}
function UE(e) {
  return "children" in e ? Ql(e) : "value" in e ? e.value : "";
}
function HE(e) {
  return e.type === "text" ? e.value : "children" in e ? Ql(e) : "";
}
function Ql(e) {
  let u = -1;
  const t = [];
...
function FE(e, u) {
  ...
  let i;
  if (u.type === "element") {
    const d = u.properties.xmlLang || u.properties.lang, s = u.properties.type || "text", E = Ls(u);
    ...
    E !== "auto" && u.tagName === "input" && s === "tel" ? i = "ltr" : (E === "auto" || u.tagName === "bdi") && (u.tagName === "textarea" ? i = On(UE(u)) : u.tagName === "input" && (s === "email" || s === "search" || s === "tel" || s === "text") ? i = u.properties.value ? On(String(u.properties.value)) : "ltr" : mi(u, o)), i && (e.direction = i)) : e.editableOrEditingHost && (e.editableOrEditingHost = !1);
  }
  return c;
  function c() {
  ...
  function o(d) {
    ...
    if (d !== u && d.type === "element" && (d.tagName === "bdi" || d.tagName === "script" || d.tagName === "style" || d.tagName === "textare" || Ls(d)))
      return Vl;
  }
}
function On(e) {
...
function jE(e, u) {
  if (e != null)
    if (typeof e == "boolean") {
      ...
      if (e.length > 0)
        return (u.commaSeparated ? Ol : Ll)(e);
    } else
      return String(e);
}
const $E = [];
...
function wt(e, u) {
  const t = e.type === "element" && QE.call(e.properties, u) && e.properties[u];
  return t != null && t !== !1;
}
const KE = Gn.default || Gn, JE = Ml("name", {
  handlers: {
    "any-link": eT,
    blank: uT,
    checked: tT,
...
function iT(e, u, t, r, a) {
  return Yu(a, e), a.elementIndex === 0;
}
function cT(e, u, t, r, a) {
  return Yu(a, e), a.typeIndex === 0;
}
function Za(e) {
  let u = e._cachedFn;
  if (!u) {
...
function dT(e, u, t, r, a) {
  return e.argument, e.argument.type, a.language !== "" && a.language !== void 0 && zE(a.language, ii(e.argument.value)).length > 0;
}
function lT(e, u, t, r, a) {
  return Yu(a, e), !!(a.elementCount && a.elementIndex === a.elementCount - 1);
}
function fT(e, u, t, r, a) {
  return Yu(a, e), typeof a.typeIndex == "number" && typeof a.typeCount == "number" && a.typeIndex === a.typeCount - 1;
}
function bT(e, u, t, r, a) {
  return !Jl(e, u, t, r, a);
}
function hT(e, u, t, r, a) {
  const n = Za(e);
  return Yu(a, e), typeof a.elementIndex == "number" && n(a.elementIndex);
}
function pT(e, u, t, r, a) {
  const n = Za(e);
  return Yu(a, e), !!(typeof a.elementCount == "number" && typeof a.elementIndex == "number" && n(a.elementCount - a.elementIndex - 1));
}
function mT(e, u, t, r, a) {
  const n = Za(e);
  return Yu(a, e), typeof a.typeCount == "number" && typeof a.typeIndex == "number" && n(a.typeCount - 1 - a.typeIndex);
}
function gT(e, u, t, r, a) {
  const n = Za(e);
  return Yu(a, e), typeof a.typeIndex == "number" && n(a.typeIndex);
}
function ET(e, u, t, r, a) {
  return Yu(a, e), a.elementCount === 1;
}
function TT(e, u, t, r, a) {
  return Yu(a, e), a.typeCount === 1;
}
function _T(e, u) {
  return !ef(e, u);
}
...
function NT(e, u, t, r, a) {
  ...
  return !!((!e.tag || XE(e, u)) && (!e.classNames || VE(e, u)) && (!e.ids || YE(e, u)) && (!e.attributes || qE(e, u, a.schema)) && (!e.pseudoClasses || ZE(e, u, t, r, a)));
}
const IT = [];
function gc(e, u) {
  u && tf(e, [], u, void 0, void 0, u);
}
function Ln(e, u, t) {
  const r = e[u];
  r ? r.push(t) : e[u] = [t];
...
function CT(e, u, t, r, a) {
  ...
  for (; ++i < u.length; ) {
    ...
    c.combinator === void 0 ? Ln(n, "descendant", c) : c.combinator === "~" && Ln(n, "generalSibling", c);
  }
  return n;
}
function Ur(e, u) {
  return e && u && e.length > 0 && u.length > 0 ? [...e, ...u] : e && e.length > 0 ? e : u && u.length > 0 ? u : IT;
}
function ws(e, u) {
  if (u.type === "element") {
...
function tf(e, u, t, r, a, n) {
  ...
  return "children" in t && !e.shallow && !(e.one && e.found) && DT(e, i, t, n), c(), i;
}
function ST(e, u, t) {
  const r = OT(e, u, t);
...
`, rf = Kt.resolve(__dirname, "../tailwind.config.cjs"), MT = async (e, u) => new Promise((t, r) => {
...
}).use(ql).processSync(e).toString(), Ms = (e) => {
  ...
  const t = require.resolve("tailwindcss/lib/cli.js"), r = u.tailwindConfigPath ?? rf, a = Kt.join(en.tmpdir(), "mailtyphoon-input.html");
  Su.writeFileSync(a, e);
  const n = Kt.join(en.tmpdir(), "mailtyphoon-input.css"), i = u.css != null ? df.compileString(u.css).css : "";
  Su.writeFileSync(n, i);
  const c = Kt.join(en.tmpdir(), "mailtyphoon-output.css");
  Su.writeFileSync(c, "");
  const o = [
    t,
    "--config",
  ...
  const d = await MT(Fs.argv0, o);
  if (d.exit_code !== 0) {
    console.error("Failed to run Tailwind."), console.error(d.stderr);
    return;
  }
  const s = Su.readFileSync(c, "utf-8") ?? "";
  return {
    html: UT(e, s, [wT, RT]),
    css: s
  };
}, ks = Ou.process.cwd(), Bs = new cf({ max: 100 }), FT = of(sf(Ou.process.argv)).option("input-html", {
  alias: "i",
  describe: "The path to your input HTML file",
  type: "string",
  default: Kt.resolve(ks, "./email.html"),
  demandOption: !0
}).option("output-html", {
  alias: "o",
  describe: "The path to the inlined HTML file that will be generated",
  type: "string",
  default: Kt.resolve(ks, "./out.html"),
  demandOption: !0
}).option("input-css", {
  alias: "c",
  type: "string",
  ...
  const u = Su.existsSync(e) ? Su.readFileSync(e, "utf-8") : "";
  return nf.createHash("sha256").update(u).digest("hex");
}, Hs = (e, u) => {
  Su.watchFile(e, { interval: 500 }, (t, r) => {
    t.mtime !== r.mtime && u();
  });
}, qT = async () => {
  const e = await FT.argv, u = e["input-html"], t = e["output-html"], r = e["input-css"], a = e["output-css"], n = e["tailwind-config"], i = e.reset, c = async () => {
    const o = Us(u), d = Us(r ?? ""), s = o + d, E = Bs.get(s);
    if (E) {
      Su.writeFileSync(t, E);
      return;
    }
    const b = Su.readFileSync(u, "utf-8"), m = {
      css: r != null ? Su.readFileSync(r, "utf-8") : void 0,
      tailwindConfigPath: n,
      reset: i !== "false"
    }, A = await HT(b, m);
    A == null && (console.log("Failed to generate output."), Ou.process.exit(1));
    const { html: L, css: I } = A;
    t != null && Su.writeFileSync(t, L), a != null && Su.writeFileSync(a, I), Bs.set(s, L);
  };
  await c(), e.watch && (Hs(u, c), r != null && Hs(r, c));
};
qT().catch((e) => {
  console.error(e), Ou.process.exit(1);
});
